...
| 2 年 10 月 | 可自訂的首頁 | 在 Experience Cloud 登陸頁面上，按一下&#x200B;**[!UICONTROL 編輯]**。您可以利用[!UICONTROL 編輯]模式來存取小工具程式庫和自訂背景，以便自訂 Experience Cloud 首頁。[!UICONTROL 編輯]模式提供流暢、直觀的控制功能，讓您可以輕鬆移動、調整大小和管理小工具，包括批次動作和版面配置調整，提供更具美感和量身打造的體驗。您還可以透過小工具庫和自訂背景來個人化您的 Experience Cloud 主頁。 |
