...
| 10 月 2 日 | 可自訂的首頁 | 在 Experience Cloud 登陸頁面上，按一下&#x200B;**[!UICONTROL 編輯]**。您可以利用[!UICONTROL 編輯]模式來存取小工具程式庫和自訂背景，以便自訂 Experience Cloud 首頁。[!UICONTROL 編輯]模式提供順暢、直覺式的控制，用於移動、調整大小及管理Widget，包括大量動作和版面調整，提供更美觀且量身打造的體驗。透過存取Widget程式庫和自訂背景，可讓您設定Experience Cloud首頁。 |
