...
| [領導者專用 Adobe Analytics 基礎知識](https://experienceleague.adobe.com/?lang=zh-hant&recommended=Analytics-L-1-2020.1) | 課程 | 在本課程中，您將了解 Analytics 基礎知識，以及 Analysis Workspace 改變企業的方式。瞭解如何透過Adobe AI發掘深入分析、聽取客戶證言，並觀看2019年峰會業界專家的精彩介紹。 |
