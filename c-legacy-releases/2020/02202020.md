...
如需產品文件，請參閱 [Experience Cloud](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html)。
...
請參閱 [AppMeasurement for Javascript 版本注意事項](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html)。版本 2.19.0 已於 2020 年 2 月 21 日發行。
...
* **Experience Manager as a Cloud Service 的教學課程**
  ...
  參照 [Experience Manager as a Cloud Service 的教學課程](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html)快速上手。
