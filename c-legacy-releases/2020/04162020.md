...
| 功能 | 說明 |
| -----------| ---------- |
| [!UICONTROL Customer Journey Analytics]：自動化資料集回填 | 此新選項可讓您將連線的所有歷史資料匯入 [!UICONTROL Customer Journey Analytics]。[更多詳情](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html) |
