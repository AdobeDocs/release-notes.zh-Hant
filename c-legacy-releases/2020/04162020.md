...
| [OSGi 簡介](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/underlying-technology/introduction-osgi.html?lang=en) | 介紹 Java™ 應用程式動態模組化架構 OSGi，此架構是 Adobe Experience Manager 的建置基礎。 |
| [Java™ Content Repository (JCR) 簡介](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/underlying-technology/introduction-jcr.html?lang=en) | 介紹 Adobe Experience Manager 所採用的 Java™ Content Repository (JCR)。 |
...
* Adobe Campaign Classic: [文件](https://experienceleague.adobe.com/docs/campaign-classic.html) - [操作說明影片](https://experienceleague.adobe.com/docs/campaign-learn/campaign-classic-tutorials/overview.html?lang=zh-Hant)
