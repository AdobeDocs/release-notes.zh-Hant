...
| 2023 年 8 月 | [[!DNL GraphQL API] 在 [!DNL AEMaaCS] 不可擴充](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22619.html) | 新文章 | 了解有關 [!DNL GraphQL API] (在 [!DNL AEMaaCS] 中) 無法擴充的資訊。 |
...
| 2023 年 8 月 | [[!DNL Campaign Classic]：擴充時發生錯誤 [!DNL BigQuery] 資料](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22687.html) | 新文章 | 了解解決方案：建立從 [!DNL BigQuery] 檢視讀取資料的工作流程，然後透過 [!DNL ACC] 表格新增豐富活動以擴充資料時，執行工作流程錯誤。 |
