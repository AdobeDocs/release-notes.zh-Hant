...
| 2023 年 9 月 | AEM Sites | [啟動](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/launches.html?lang=zh-Hant) | 更新的影片 | 「[!UICONTROL 啟動]」(在 [!DNL AEM Sites] 中) 提供建立、編寫和檢閱未來發布內容的方式。 |
...
| 2023 年 8 月 | [在「作者」上刪除內容之後，內容並未從預覽取消發布](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22685.html?lang=zh-Hant) | 新文章 | 了解解決方法：如果先前已發布至預覽的頁面在未先從預覽停用的情況下刪除，就不會從預覽中刪除。 |
...
| 2023 年 8 月 | [Adobe Commerce 2024 發佈排程](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/2024-release-schedule.html?lang=zh-Hant) | 新文章 | 了解我們更新的 2023 年發布策略，以擴大支援範圍、提供更多安全性更新，並加速創新採用。 |
