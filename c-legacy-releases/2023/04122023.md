...
| 2023 年 4 月 | [API Mesh 快速入門](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-developer-app-builder/api-mesh/getting-started-api-mesh.html?lang=zh-Hant) | 影片 | 了解如何在 [!DNL Adobe Commerce] 和 [!DNL Adobe App Builder] 上使用 API Mesh。了解如何安裝 [!DNL Adobe App Builder]、處理專案、建立 GraphQL 反向 Proxy 等。 <p>相關：新的 [entityId 範例](https://experienceleague.adobe.com/docs/commerce-merchant-services/catalog-service/mesh.html?lang=zh-Hant)已新增到 _適用於目錄服務的 API Mesh_ 產品文件中。 |
