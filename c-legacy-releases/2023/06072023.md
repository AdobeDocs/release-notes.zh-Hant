...
# Experience Cloud 版本注意事項 - 2023 年 6 月
...
觀看 [2023年2月版本總覽影片](https://video.tv.adobe.com/v/3416885) 2023.02.0 （2023年2月）版本新增功能摘要。 <!-- OLD. UPDATE ON JUNE 7 -->
...
* 為 Dynamic Media 影片傳遞 (啟用 CMAF) 中的自適應串流推出的新通訊協定 (DASH - 基於 HTTP 的動態自適應串流) 支援：<!-- OLD. UPDATE FOR JUNE 7 -->
   ...
   * 在亞太和北美地區有提供；[由支援票證啟用](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/video.html#enable-dash)。即將於歐洲 — 中東 — 非洲推出。<!-- OLD. UPDATE FOR JUNE 7 -->
* 已新增對 WebP 影像的支援以自動擷取中繼資料、產生縮圖並自訂轉譯。這些檔案現在也支援智慧標籤和智慧裁切功能。<!-- OLD. UPDATE FOR JUNE 7 -->

### [!DNL Experience Manager Forms] as a [!DNL Cloud Service]

_新功能_

* **[使用資料擷取核心元件以建置最適化表單](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/introduction.html)** – [使用最適化表單編輯器](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/creating-adaptive-form-core-components.html)根據標準化的資料擷取元件 (核心元件) 建立表單。這些元件提供自訂功能、縮短開發時間，並降低數位註冊體驗的維護成本。<!-- OLD. UPDATE FOR JUNE 7 -->
* **[前端管道支援設計以核心元件為基礎之最適化表單的樣式](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/using-themes-in-core-components.html)**：為以核心元件為基礎之最適化表單使用標準化的 BEM 型主題。您可以使用前端部署管道部署它們，以增強表單的外觀和風格。它還有助於符合您組織的品牌核准設計准則。<!-- OLD. UPDATE FOR JUNE 7 -->
...
使用 Headless 最適化表單讓您的開發人員能夠建立、發佈和管理可透過 API 存取和互動的互動式表單，而不是透過傳統的圖形使用者介面。Headless調適型表單可協助您：<!-- OLD. UPDATE FOR JUNE 7 -->
...
* 使用 AEM 6.4 設定專案連結的資料夾時，[!DNL Experience Manager] 未儲存「**子資料夾**」和「**在產品組合的專案中建立連結的資料夾**」欄位的值。「**sub-folders**」欄位的值更新為&#x200B;**未定義**。的值 **在具有投資組合的專案中建立連結資料夾** 欄位更新至 **預設Portfolio** 儲存設定後自動進行。 <!-- NEW. LEAVE IN FOR JUNE 7 -->
* 當您使用傳統 Workfront 體驗時，「**更多**」下拉式清單中的「**傳送至**」選項不允許您選取 Experience Manager 中的目標目的地。 使用「**文件動作**」下拉式清單時，「**傳送至**」選項正常運作。此 **傳送至** 選項正確運作於 **更多** 下拉式清單與 **檔案動作** 新Workfront體驗中可用的下拉式清單。<!-- NEW. LEAVE IN FOR JUNE 7 -->
