...
| 2023 年 6 月 | [使用 CRM 來源連接器 (Salesforce) 擷取資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-crm.html) | 影片 | 了解如何以無縫連接方式將 CRM 來源資料大量擷取至[!UICONTROL 即時客戶輪廓]和資料湖。 |
