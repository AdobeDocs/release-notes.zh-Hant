...
* 當[憑證](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html)到期時，與該憑證關聯的[網域名稱](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-domain-names/introduction.html)和 [IP 允許清單](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/ip-allow-lists/introduction.html)將不再從 CDN 中刪除。在這種情況下，網站仍接受訪客造訪。
* Cloud Manager UI 提供更明顯的警告：[SSL 憑證](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html)即將到期。
* 已修復客戶無法建立或刪除環境的罕見情況。
...
>[!IMPORTANT]
>
>Adobe 建議您升級到適用於 Experience Manager 增強型連接器的[最新 1.9.9 版本](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html) Workfront。
...
| 2023 年 5 月 | [了解增強分析中的資源產能圖表](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/enhanced-analytics/19-resource-capacity-chart.html) | 影片 | 了解資源產能圖表如何顯示在篩選的時段內指派給主團隊的規劃時數與團隊的總可用時數的比較。 |
...
| 2023 年 5 月 | [了解增強型分析中的團隊產能](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/reporting/enhanced-analytics/20-team-capacity-overview.html) | 文章 | 了解團隊產能圖表如何顯示主團隊何時分配過多或過少。 |
