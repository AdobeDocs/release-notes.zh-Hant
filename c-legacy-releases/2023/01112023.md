...
| 2023 年 1 月 | [使用篩選器 (標記)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/using-filters-tags-in-the-left-rail.html) | 已更新的影片 | 瞭解如何在Analysis Workspace中使用篩選器（稱為標籤）。 這些是有助於您有效率地建置專案的省時技巧。 |
...
| 2023 年 1 月 | [使用鍵盤快速鍵](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/keyboard-shortcuts.html) | 已更新的影片 | 瞭解如何使用Analysis Workspace中的鍵盤快速鍵。 這些是有助於您在專案中執行各種任務的省時技巧。 |
| 2023 年 1 月 | [複製和插入面板和視覺效果](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/copy-insert-analysis-workspace.html) | 已更新的影片 | 瞭解如何在Analysis Workspace中複製和插入面板和視覺效果。 這些是調整目前專案或搶先一步進行新專案的省時技巧。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2023 年 1 月 | [使用 Report Builder 對 Customer Journey Analytics 活頁簿進行排程](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/exporting/report-builder/schedule-cja-workbooks-using-report-builder.html) | 影片 | 瞭解如何排程Report Builder活頁簿以進行Customer Journey Analytics。 排程活頁簿可讓使用者以最新資料重新整理Report Builder活頁簿的程式自動化，並按照預先定義的定期排程將其傳送給利害關係人。 |
...
* Experience Manager Assets現在為影像智慧標籤使用改良的人工智慧架構。 此內容智慧可提高智慧標記的相關性和準確性，在擷取時可用於所有影像資產。此外，方向資訊會填入`cq:tags`中，這樣可以使用「方向」篩選器獲得更好的搜尋結果。
...
* Dispatcher設定現在會參照一個列出常見行銷活動查詢引數的檔案。 客戶可以選擇取消註解與其相關的引數，以獲得更好的快取。 請參閱[行銷活動參數](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/caching.html#marketing-parameters)，以取得更多詳細資料。
...
* 當資料夾使用的綱要在全域設定中缺少定義時，建立連結到 [!DNL Workfront] 中 Experience Manager 的資料夾時出現的問題。
