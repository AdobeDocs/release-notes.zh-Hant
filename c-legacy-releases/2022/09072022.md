...
| **[!DNL Adobe Workfront]** | 工作坊 | 圖表工作流程 - 加入客戶成功團隊，即時討論和逐步說明圖表工作流程 (從接收到完成)，並了解如何為有效的工作管理實踐奠定堅實的基礎。 <p>**9 月 20 日** - [詳細資料和報名](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,hKbbhANIJ0GUZ80-hyYRPQ,eHZZsesEKEW-f54PGw4z9w,8IgA8CD5yEyKFei9pwlDJA,iACjdG_hK0m1uoTTaMinZA,TEaHrWBF3USQb49XCqymTg?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) |
| **[!DNL Adobe Workfront]** | 網路研討會 | _System Admin Essentials：資源管理快速入門_ - 使用 Adobe [!DNL Workfront] 管理您的資源是非常理想的選擇 - 您可了解需要完成的工作、可存取哪些資源，並根據它們的可用性進行指派。加入我們以了解如何進行。<p>**9 月 21 日上午 8:00 (英國時間)** - [詳細資料和報名](https://webinars.on24.com/adobe_workfront/AdminEssentialsRM?partnerref=exl) |
| **[!DNL Adobe Workfront]** | 工作坊 | _價值實現系列：使用專案範本的理由_ - 加入我們，討論[!UICONTROL 專案範本]及其為組織增加價值和提升效率的各種方式。我們集思廣益，用各種方法 (按活動、按可交付成果等) 來建構範本以支援您的專案。我們會示範一些我的最愛資料夾，並瀏覽我們最新的藍圖。 <p>**9 月 21 日下午 12:30 (北美山區時區)** - [詳細資料與報名](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,fir0yEdzREq77VYkVxk2kw,W3nJ9w4q-U69PVqUTk7D6Q,zs6GtWtgRkyikfMUMzBEmw?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) |
| **[!DNL Adobe Workfront]** | 工作坊 | _讓您和您的使用者按照計劃進行的 10 個溝通技巧_ - 有效的溝通是您、您的使用者，和最終達成公司成功非常重要的一環。本次工作坊提供了十個技巧 (無論是在 [!DNL Workfront] 中還是之外)，以幫助提高績效、生產力並降低不必要的問題風險。 <p>**9 月 22 日下午 7:00 (北美山區時區)** - [詳細資料與報名](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,PiX3iDTmREqs2eOICcUIoA,5KJVGb6S_Uiiki7ErNALgw,Jcg3aU0zf0uG9pB-_vmCUg,pdnZcB-mqk2_nMKUQEQnsA,xYRXQWa6OU6_tvNTp_vuFQ?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) |
| **[!DNL Adobe Campaign Classic]** 和 **[!DNL Adobe Campaign Standard]** | 工作坊 | _社群問答時間_ - 針對 [!DNL Adobe Campaign] 測試人員網路研討會&#x200B;_假期和旺季期間成功清單_&#x200B;中討論的主題，與 Tamara Wulf 和 Earl Ross 一起討論您的疑問。 <p>**9 月 22 日下午 8:00 (北美山區時區)** - [詳細資料與報名](https://adobe.ly/3KHrGpl) |
| **[!DNL Adobe Workfront]** | 工作坊 | _使用儀表板推動採用：規劃師_ - 加入客戶成功團隊，我們將繼續根據 [!DNL Adobe Workfront] 角色探討新儀表板系列。本次研討會討論的重點在於經常擔任專案或行動方案管理角色的規劃師。了解如何為活動意識和責任建立一個積極主動、以團隊為主的空間。 <p>**9 月 27 日上午 9:00 (北美山區時區)** - [詳細資料與報名](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,hKbbhANIJ0GUZ80-hyYRPQ,eHZZsesEKEW-f54PGw4z9w,Y1He1usOwUaIvlln-RiUCw,PbQY6cwRBkiHr0Uxk8YBow,2QMMEWx0e0C65kbQ1d4cIA?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1) |
