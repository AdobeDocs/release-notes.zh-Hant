...
| 發佈日期 | 名稱 | 類型 | 說明 | 應用程式 |
| ------| ----- | -----| ------ | --- |
| 2022 年 3 月 | [整合 Experience Manager — 概覽](https://experienceleague.adobe.com/docs/campaign-learn/integrate-with-experience-manager/overview.html?lang=zh-Hant) | 影片 | 連結 Adobe Campaign 與 Adobe Experience Manager，以便能夠管理 Experience Manager 的電子郵件傳遞範本、資產和表單。 | AEM，Campaign v8 |
