...
| Campaign [!UICONTROL Audiences] | (3 月 12 日發布；[!DNL Microsoft® Advertising] 帳戶適用的 Beta 功能，符合[!UICONTROL 目標客戶比對]資格) 您現在可以透過電子郵件地址上傳 CSV 檔案來建立和管理目標客戶比對對象。資料必須使用 SHA-256 演算法進行雜湊處理。 |
