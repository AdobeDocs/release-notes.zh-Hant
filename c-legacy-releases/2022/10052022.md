...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 10 月 | [內部部署安裝概覽](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/overview.html?lang=zh-Hant) | 產品文件 | 了解 Adobe Commerce 和 Magento Open Source 的內部部署的安裝程序。 |
