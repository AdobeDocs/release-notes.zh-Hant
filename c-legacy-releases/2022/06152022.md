...
* **Experience Manager Assets as a Cloud Service**
   ...
   * Experience Manager Assets 目前使用 Adobe Sensei AI 功能，以便[區分影像中的顏色，並在擷取時自動將差異套用為標記](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/color-tag-images.html)。這些標記會根據影像顏色組合來增強搜尋體驗。您可以設定標記到影像的顏色數量 (範圍在 1 到 40 之間)，以便以後可以根據這些顏色搜尋影像。
