...
| [!DNL Inventory Inspector] | (6 月 29 日發行) 位置[!UICONTROL 檢視窗]的「[!UICONTROL 詳細目錄]」標籤現在包含可自訂的資料視覺效果圖表和擴充的績效量度，例如：[!UICONTROL 可見率]、[!UICONTROL 點按次數]和[!UICONTROL 昨天的 CPM]。 |
