...
| 2022 年 4 月 | [以非技術方式翻譯 Adobe Analytics 技術語言](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/key-admin-skills/translating-adobe-analytics-technical-language.html?lang=zh-Hant#) | 影片 | 身為貴組織的Adobe Analytics專家，您是協助利害關係人了解技術詳細資訊並充分運用Adobe Analytics投資的關鍵。 |
...
| 2022 年 4 月 | [CJA 中的連線詳細資料體驗](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/connections-details-experience-in-cja.html?lang=zh-Hant) | 影片 | 了解如何檢查連線資料集的狀態和擷取程式。 |
...
| 2022 年 4 月 | [使用存放庫瀏覽器來偵錯 AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/repository-browser.html) | 影片 | 了解Repository Browser，這是一款功能強大的工具，可顯示AEM的基礎資料存放區，以便輕鬆偵錯AEMas a Cloud Service環境。 | AEM CS |
...
| 2022 年 4 月 | [在傳送文件後進行修改](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/modify-in-flight.html?lang=zh-Hant) | 影片 | 了解如何修改已發出供簽名的文檔，例如錯誤發出錯誤的文檔。 | Adobe Sign |
...
| 2022 年 4 月 | [自動化法律工作流程](https://experienceleague.adobe.com/docs/document-services/tutorials/usecases/automatelegalworkflows.html) | 文章 | 了解如何使用根據核准的語言而改變的預先定義的範本，管理並安全地執行合約條款。 | 檔案服務 |
| 2022 年 4 月 | [將員工上線過程現代化](https://experienceleague.adobe.com/docs/document-services/tutorials/usecases/employeeonboarding.html) | 影片 | 了解如何使用 Adobe Document Services API 將員工上線過程現代化。 | 檔案服務 |
