...
| 發佈日期 | 名稱 | 類型 | 說明 | 應用程式 |
| -----------| ---------- | ---------- | ---------- |---------- |
| 2022 年 5 月 | [區段比對預先分享見解](https://experienceleague.adobe.com/docs/platform-learn/tutorials/segments/segment-match-pre-share-insights.html?lang=zh-Hant) | 影片 | 在您決定與策略合作夥伴共用資料時，了解客戶配對情況非常重要，這樣您就知道資料共用將有多大幫助。「區段比對」可讓您在共用任何資料之前查看與潛在資料合作夥伴的重疊。 | [!DNL Real-time Customer Data Platform] |
...
| 2022 年 5 月 | [在 Tableau 中使用查詢服務來分析及視覺化全通路見解](https://experienceleague.adobe.com/docs/platform-learn/tutorials/queries/analyze-and-visualize.html?lang=zh-Hant) | 影片 | 了解如何在流失分析範例中搭配使用 Adobe Experience Platform 的查詢服務與外部資料視覺化工具。 | Experience Platform |
