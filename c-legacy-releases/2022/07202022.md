...
若要向 Adobe 產品專家學習、與之互動或獲得解答，Experience League 活動是您絕佳的選擇！請查看 Experience League 上的[活動](https://experienceleague.adobe.com/events/)，以掌握 2022 年 7 月活動的最新消息。
...
* [地點](https://experienceleague.adobe.com/docs/places/using/home.html)
...
* [資料串流](https://experienceleague.adobe.com/docs/experience-platform/edge/datastreams/overview.html)
...
| 2022 年 7 月 | [將範例資料匯入 Adobe Experience Platform](https://experienceleague.adobe.com/docs/platform-learn/tutorials/import-sample-data.html?lang=zh-Hant) | 文章 | 瞭解如何設定包含範例資料的 Experience Platform 沙箱環境。您可以使用 Postman 集合來建立欄位群組、綱要、資料集，然後將範例資料匯入 Experience Platform。 | Experience Platform |
...
| 已發佈 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 7 月 | [設定下一個和上一個項目面板](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/panels/configure-next-previous-item-panel.html?lang=zh-Hant) | 影片 | 瞭解如何在 [!DNL Customer Journey Analytics] 設定下一個和上一個項目面板。 此面板會產生表格和視覺化效果以識別特定維度值的下一個或上一個項目。 |
...
* [2022 年 6 月版總覽影片](https://video.tv.adobe.com/v/344308/?quality=12)，瞭解 2022.6 版的摘要。

較舊產品更新影片：

* [2022 年 5 月版總覽影片](https://video.tv.adobe.com/v/343321/?quality=12)，瞭解 2022.5.0 (2022 年 5 月) 版中新增功能的摘要。
...
| 2022 年 7 月 | [Adobe Commerce 的 B2B - 教學課程](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/company-accounts.html) | 影片 (多個) | 瞭解 Adobe Commerce 中的「[!UICONTROL 公司]」頁面。您可以管理您的公司帳戶，任何待核准的請求都會顯示在清單的頂端。 |
...
| 已發佈 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 7 月 | [建立對象](https://experienceleague.adobe.com/docs/target-learn/tutorials/audiences/create-audiences.html?lang=zh-Hant) | 影片 | 瞭解在 [!DNL Target] 中建立和儲存自訂對象，以便在您的活動中使用。 |
...
* [控制面板 6 月版](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html)
...
| 2022 年 7 月 | [在 Adobe Campaign Classic 中開發和自訂資料模型](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/customer-journeys/2022/data-models.html) | 影片 (Skill Builder 活動) | 與我們的 Campaign 培訓師一起參加此會議，瞭解如何在 Campaign Classic 中的資料模型內開發資料綱要。 | Campaign Classic v7 |
