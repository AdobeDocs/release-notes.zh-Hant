...
| 2021 年 10 月 | [什麼是數位簽名](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-signing/sign-with-a-digital-signature.html?lang=en) | 影片 | 瞭解符合全球最嚴格法規，並提供簽名者身分最高保證等級的憑證式數位簽名。 |
...
| 2021 年 10 月 | [在工作流程中使用 SOAP API - 簡介](https://experienceleague.adobe.com/docs/campaign-learn/use-soap-apis/introduction.html?lang=en) | 教學課程 | 了解如何使用 Adobe Campaign Soap API，並根據透過 API 收到的資料，建立進階的傳遞工作流程。 |
