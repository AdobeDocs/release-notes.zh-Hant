...
| 2021 年 2 月 3 日 | [啟用非 Adobe 應用程式的資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-data-to-non-adobe-applications.html?lang=zh-Hant) | 影片 | 了解 Adobe 的 Real-Time CDP 如何幫助您制定真正個人化策略來吸引您的受眾。此外，了解它如何融入您現有的生態系統以及 Microsoft®、Google 和 Facebook 提供的非 Adobe 應用程式。 |
