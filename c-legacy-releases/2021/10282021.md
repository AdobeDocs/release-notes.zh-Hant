...
[Experience League LIVE](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html) 是 Experience League 團隊製作的直播串流節目。您可以藉此機會與 Adobe 產品專家交流，並學到您可以透過 Adobe Experience Cloud 應用程式應用可落實的秘訣、技巧和策略。
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 11 月 | 第一方資料內容中的[資料Collaboration](https://experienceleague.adobe.com/docs/platform-learn/tutorials/industry/data-collaboration-in-the-first-party-data-context.html#) | 影片 | 實踐體驗承諾，存取較少的資料。無論您是否為廣告商、發佈者或機關，此網路研討會有助於未來在無第三方 Cookies 的情況下解放共同作業機會。 |
...
| 2021 年 11 月 | [在工作流程中使用 SOAP API](https://experienceleague.adobe.com/docs/campaign-learn/use-soap-apis/introduction.html) | 教學影片 | 了解如何使用 Adobe Campaign Soap API 並根據透過 API 接收的資料建立進階傳送工作流程。 | Campaign V8 |
...
| 2021 年 11 月 | [在Office中建立網頁版PDF](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/integrations/createofficeweb.html?lang=zh-Hant) | 影片 | 了解即使離開網頁應用程式的 Microsoft® Office，也能建立 PDF 檔案。此附加元件需要適用於團隊的 Acrobat DC 訂閱或適用於企業的 Acrobat DC 訂閱。 |
