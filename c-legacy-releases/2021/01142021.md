...
需要協助嗎? 請造訪 [Experience League](https://experienceleague.adobe.com/zh-hant?lang=zh-Hant/#home)，尋找產品和技術文件、Adobe 策畫的課程、教學課程影片、快速解答、社群見解，以及由講師授課的訓練課程。內容已從 `experienceleague.adobe.com` 移至此處，請更新書籤。
...
如需最新發行資訊，請參閱 [Experience Cloud 服務的彙整版本注意事項](https://experienceleague.adobe.com/docs/core-services/interface/release-notes/release-notes.html?lang=zh-Hant)。
