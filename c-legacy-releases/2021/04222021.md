...
| 私人詳細目錄 | (10 月 15 日發行) 所有用戶現在都能使用新交易 ID 表單來設定及編輯交易 ID 詳細資訊，此表單是舊版「智慧型廣告服務」表單的簡化版本。若要設定新交易 ID 詳細資訊，請前往&#x200B;**[!UICONTROL 「詳細目錄]** > **[!UICONTROL 交易]** > **[!UICONTROL 建立」]**，然後選取&#x200B;**[!UICONTROL 「交易 ID Beta 版」]**。 |
