...
* [[!DNL Analytics]](#analytics)和[Customer Journey Analytics](#cust-journey) **（2021年8月10日更新）**
...
| 功能 | 日期 | 說明 |
| ------- | ------- | -------|
| Experience Cloud ![全域搜尋](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html#globally-search-for-objects-and-entities) | 2021 年 7 月 5 日 | 在這個版本中，Experience Cloud 全域搜尋將 Journey Orchestration 新增到 Experience Cloud 中的商業物件搜尋中，例如區段、資料集、結構描述等。 |
...
| 2021 年 7 月 | [資料工程師適用的查詢服務快速入門](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-D-1-2021.1.qsvc.gsde) | 課程 | 了解如何驗證已擷取的資料、從儲存在資料湖中的資料獲得洞察，以及如何使用查詢服務來為業務關鍵型決策準備資料。 |
| 2021 年 7 月 | [使用查詢服務建立儀表板](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-D-1-2021.1.qsvc.dash) | 課程 | 了解如何驗證已擷取的資料、從儲存在資料湖中的資料獲得洞察，以及使用 Adobe Experience Platform 中的查詢服務來建立儀表板。 |
...
| 2021 年 7 月 | [資料科學家適用的 Data Science Workspace 快速入門](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-U-1-2021.1.dsw) | 課程 | 了解 Adobe Experience Platform 中的 Data Science Workspace。 此課程專為想要學習如何使用 [!DNL JupyterLab] Notebooks 以獲得洞察和查詢資料、建立具有輪廓功能的資料集、發佈自動化機器學習模型，以及對 Adobe 和非 Adobe 應用程式啟用機器學習見解的資料科學家所設計。 |
| 2021 年 7 月 | [Adobe Experience Platform Data Governance 快速入門](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-D-1-2021.1.dgov.gs) | 課程 | 瞭解如何掌控您的資料，包括在資料來源處收集資料，以及將資料整合到Adobe Experience Platform外部的目的地。 |
...
* **2021 年 6 月發行版：** AI 排名可讓您根據您的業務目標建立不同的排名策略，受過訓練的模型系統將使用這些策略，針對向給定輪廓顯示的合格產品建議進行排名。

如需最新資訊，請參閱 [Offer Decisioning 發行說明](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=zh-Hant)。

**適用於 Offer Decisioning 的更多資源**

[文件](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/get-started/starting-offer-decisioning.html?lang=zh-Hant) - [版本注意事項](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=zh-Hant) - [做法影片](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/introduction-to-decision-management.html?lang=zh-Hant)
...
* [Customer Journey Analytics的新功能](#cust-journey) （2021年8月10日更新）
...
加入我們的行列，聆聽每個 Adobe Analytics 實作團隊都應該知道的具體技巧，並讓 Eric Matisoff 在聊天窗格中回答您的問題。 這是即時活動，因此您不需要事先報名，但請務必記在您的行事曆上，這樣您才不會錯過！

**活動：**&#x200B;[Adobe Analytics 實作 - 秘訣與技巧](https://www.youtube.com/watch?v=lxOvLCzEGBI)

**時間：** 2021年7月29日上午9:00 PDT
...
| 功能 | 說明 | [全面發佈](https://experienceleague.adobe.com/docs/analytics/release-notes/releases.html) - 目標日期 |
| ----------- | ---------- | ------- |
...
* 已修正Workspace專案未開啟的問題（逾時）。(AN-247248)
...
| 注意 | 新增或更新日期 | 說明 |
| ----------- | ---------- | ---------- |
| Adobe Data Connectors 終止服務 | 2021 年 8 月 3 日 | Adobe [!UICONTROL Data Connectors] 的舊技術已無法使用或不再支援。您可以針對任何整合使用該項標準，以繼續獲得產品供應和支援。生命週期結束的官方日期為 **2021 年 8 月 19 日**。 [了解更多...](https://experienceleague.adobe.com/docs/analytics/import/dataconnectors/data-connectors-eol.html) |
| 三個 Analytics API 服務結束生命週期 | 2021 年 7 月 15 日 | 下列 Analytics Legacy API 服務將在 **2021 年 8 月 18 日**&#x200B;結束生命週期並關閉。 所有目前使用這些服務建立的整合功能將於當天停止運作。<ul><li>1.3 Analytics API</li><li>1.4 SOAP Analytics API</li><li>Legacy OAuth 驗證 (OAuth 和 JWT)</li></ul>Adobe 提供了[舊版 API 生命週期結束常見問答](https://github.com/AdobeDocs/analytics-1.4-apis/blob/master/docs/APIEOL.md?mv=email)來回答您的問題，並指引您展開後續操作。 採用這些服務的 API 整合應用可移轉為 [1.4 Analytics REST API](https://github.com/AdobeDocs/analytics-1.4-apis?mv=email) 或 [2.0 Analytics API](https://github.com/AdobeDocs/analytics-2.0-apis?mv=email)。Legacy OAuth 帳戶可移轉為 [Adobe I/O](https://developer.adobe.com/console/home?mv=email) Analytics 整合帳戶，藉以存取 1.4 Analytics API 和 2.0 Analytics API。 |
| 完整處理資料來源的生命週期結束 | 2021 年 4 月 12 日 | Adobe 計劃在 **2021 年 7 月 31 日**&#x200B;淘汰完整處理資料來源。 自 2021 年 3 月 25 日起，將無法再建立此類型的新匯入。請利用[大量資料插入 API](https://developer.adobe.com/apis/experiencecloud/analytics/docs.html) 匯入此類資料。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 7 月 | [在您的專案中使用環形圖視覺效果](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/using-the-donut-visualization.html) | 影片 | 了解如何在您的 Analysis Workspace 專案中新增及設定環形圖視覺效果。 |
| 2021 年 7 月 | [橫條圖和堆疊橫條圖視覺效果](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/bar-and-bar-stacked-visualizations.html) | 影片 | 在這段影片中，我們將討論如何在您的 Analysis Workspace 專案中新增及設定橫條圖、堆疊橫條圖、水平橫條圖和水平堆疊橫條圖等視覺效果。 雖然這些被視為基本的視覺效果，但有助於訴說您的資料故事，並提供分析人員洞察。 |
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Guides as a Cloud Service**
      ...
      * **雲端原生元件內容管理系統** - Experience Manager Guides 現在以 Cloud Service 的形式提供。 取得可讓您大規模撰寫、管理及交付文件與內容的環境。
      * **AI 支援的文件** - 智慧型標記功能，可自動從文字中識別及擷取相關的中繼資料關鍵字，以賦予中繼資料標籤。
      * **網頁編輯器的全新外觀** - 全新外觀，再加上 UI 變更，讓此編輯器變得更直覺好用。 底層架構已從珊瑚色更改為根據反應的色彩頻譜。

     請瀏覽 [Experience Manager Guides](https://business.adobe.com/products/experience-manager/guides/aem-guides.html) 以取得詳細資訊。

   * **AEM as a Cloud Service 中的 Cloud Manager**

      * [!UICONTROL 預覽服務]會以滾動方式部署到所有計劃。 當客戶的計劃有啟用[!UICONTROL 預覽服務]時，他們會在產品內收到通知。 請參閱「[存取預覽服務](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-environments.html)」。
      ...
      * 已新增程式碼品質規則來驗證 `damAssetLucene` 索引的結構。 請參閱「[自訂 DAM 資產 Lucene Oak 索引](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/custom-code-quality-rules.html)」。
      * 「環境詳細資料」頁面現在會適當地顯示發佈和預覽服務的多個網域名稱。 請參閱「[環境詳細資料](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-environments.html)」。
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * [資產大量擷取工具](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/add-assets.html)可讓您在大量擷取期間新增中繼資料。

     Assets 發行前管道的新功能：

      * 已增強檢視設定，好讓您可以選擇預設檢視及預設排序參數。
      * [!UICONTROL 連結共用]下載功能會使用可提高下載速度的非同步下載。 請參閱「[下載使用連結共用所共用的資產](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/download-assets-from-aem.html)」。
      * 您可以根據屬性述詞來搜尋及篩選資料夾。
      ...
      * 使用者體驗增強功能會顯示存在於資料夾中的資產數量。 若資料夾中有超過 1000 個資產，Assets 會顯示 1000+。
      * 您可以在資料夾的「屬性」中，直接將中繼資料結構描述套用到該資料夾。
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * 使用者體驗增強功能會顯示存在於資料夾中的資產數量。 若資料夾中有超過 1000 個資產，Experience Manager 資產會顯示 1000 個以上。
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 7 月 | [Experience Manager Guides](https://experienceleague.adobe.com/docs/experience-manager-guides-learn/tutorials/overview.html) | 文章 | 了解 [!UICONTROL XML 文件解決方案]如何提供所有核心 CCMS 功能，例如共同作業、檢閱、翻譯、搜尋及 DITA 內容報告。 這些功能可讓作者透過有效率的內容重複使用和強大的工作流程達到事半功倍之效。 |
| 2021 年 7 月 | [AEM Headless GraphQL Postman 集合](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/modeling-basics.html) | 影片 | 了解如何在 Adobe Experience Manager (AEM) 中定義及使用內容片段以搭配 GraphQL 使用。 |
...
* [Experience Manager as a Cloud Service 版本注意事項](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html?lang=zh-Hant)
...
* [Livefyre 版本注意事項](https://experienceleague.adobe.com/docs/discontinued/using/livefyre.html?lang=zh-Hant)
...
* [Campaign v8 發行說明](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/whats-new.html)
...
| 發佈日期 | 名稱 | 解決方案 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 7 月 | [合併查詢結果以縮小目標範圍](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/process-management/targeting-workflows/refine-targets-by-combining-query-results.html) | Campaign v8 | 了解如何使用交集或聯合活動，在工作流程中合併查詢結果，藉此縮小目標範圍。 |
...
| 2021 年 7 月 | [使用 Adobe PDF Embed API 發佈數位文件](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/ddppdfembedapi.html) | 文章 | 您可以藉由將 PDF 檢視器嵌入在網頁中，讓使用者能夠檢視文件，而不需要重新設計您的 HTML 和 CSS 或是阻撓對您網站的存取。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 讓學生和教師共同作業](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/educationcollab.html) | 文章 | 了解 `Node.js` 應用程式適用的官方 SDK，以存取 PDF Services API。 這可讓您將類似 Microsoft® Word 或 Microsoft® Excel 等文件轉換成 PDF。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 發佈職缺公告](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/jobposting.html) | 文章 | 在經營有多個使用者的網站時，設計可確保所有人都能順暢使用的體驗至關重要。 了解如何將所有上傳的文件自動轉換成 PDF，並將其嵌入到公告中。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 建立及編輯報告](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reportcreation.html) | 文章 | PDF 採用所有人都可以檢視的格式，讓使用者輕鬆地分享包含表格、圖形和互動式內容的豐富文件。 了解如何將這些統計資料與他們的高階主管、股東、捐款人和其他利害關係人分享。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 審查及核准](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reviews.html) | 文章 | 了解如何使用多個 Adobe Document Services API 來處理親手審查和核准使用案例。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 搜尋及建立索引](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/searching.html) | 文章 | 本教學課程會探索Adobe Document Services API的絕佳功能，並說明如何輕鬆地使用這些API來封存檔案並將檔案數位化。 我們探索這些功能的方式如下：建置 Express NodeJS 應用程式，然後整合 Document Services API 來封存文件、將文件數位化及轉換文件。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 管理員工錄取通知](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/offer.html) | 文章 | 此教學課程會逐步解說如何設定 Node Express 專案，該專案會顯示網頁表單以供使用者填寫員工詳細資料。 這些詳細資料會在網頁上使用 Document Services 來產生 PDF 格式的錄取通知，該錄取通知可以在稍後傳遞給客戶，以便使用 Adobe Sign API 來收集他們的簽名。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 管理法律合約](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/legal.html) | 文章 | 在此教學課程中，我們會在文件中產生自訂輸入欄位，藉此來探索 Adobe Document Services API 的功能。 我們也會探索您如何輕鬆地將這些產生的文件轉換成受保護的可攜式文件格式 (PDF) 以防止資料被操控。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 建立 NDA](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/nda.html) | 文章 | 了解如何為貴公司的 NDA 建立 Microsoft® Word 範本。 Adobe適用於Microsoft®Word、Adobe Document Generation Tagger的免費增益集可幫助您插入「標籤」以輸入動態值。 您也會了解如何將 JSON 資料傳遞給範本並建立動態 PDF。 然後您可以透過電子郵件傳送該 PDF 或是透過瀏覽器向您的共同作業人員顯示 (視您的業務需求和目標而定)。 |
| 2021 年 7 月 | [使用 Adobe Document Services API 管理銷售提案](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/sales.html) | 文章 | 了解如何使用動態資料和工作流程，以打造有效率的流程來建立銷售提案。 |
| 2021 年 7 月 | [使用 Adobe Document Generation API 處理發票](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/invoices.html) | 文章 | 了解如何使用 Adobe Document Generation API 來自動產生發票、使用密碼保護 PDF 並為每個客戶提供發票。 只需要少少的 Node.js、JavaScript、Express.js、HTML 和 CSS 知識即可辦到。 |
