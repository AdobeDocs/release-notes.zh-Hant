...
* [Customer Journey Analytics](#cust-journey)中的新功能（2021年8月10日更新）
...
| 2021 年 7 月 | [使用 Adobe Document Services API 搜尋及建立索引](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/searching.html) | 文章 | 本教學課程會探索AdobeDocument Services API的絕佳功能，並說明如何輕鬆地使用這些API來封存檔案並將檔案數位化。 我們探索這些功能的方式如下：建置 Express NodeJS 應用程式，然後整合 Document Services API 來封存文件、將文件數位化及轉換文件。 |
