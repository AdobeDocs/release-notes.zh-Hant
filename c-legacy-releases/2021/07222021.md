...
| 2021 年 7 月 | [使用 Adobe PDF Embed API 發佈數位文件](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/ddppdfembedapi.html?lang=zh-Hant) | 文章 | 您可以藉由將 PDF 檢視器內嵌在網頁中，讓使用者能夠檢視文件，而不需要重新設計您的 HTML 和 CSS 或是阻撓對您網站的存取。 |
...
| 2021 年 7 月 | [使用 Adobe Document Services API 發佈職缺公告](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/jobposting.html?lang=zh-Hant) | 文章 | 在經營有多個使用者的網站時，設計可確保所有人都能順暢使用的體驗至關重要。 了解如何將所有上傳的文件自動轉換成 PDF，並將其內嵌到公告中。 |
...
| 2021 年 7 月 | [使用 Adobe Document Services API 搜尋及建立索引](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/searching.html?lang=zh-Hant) | 文章 | 本教學課程會探索AdobeDocument Services API的絕佳功能，並說明如何輕鬆地使用這些API來封存檔案並將檔案數位化。 我們探索這些功能的方式如下：建置 Express NodeJS 應用程式，然後整合 Document Services API 來封存文件、將文件數位化及轉換文件。 |
