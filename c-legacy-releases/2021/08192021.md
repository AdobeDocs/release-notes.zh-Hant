...
| 2021 年 8 月 | [設定以檔案為基礎的雲端儲存空間或電子郵件行銷目的地](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configuring-file-based-cloud-storage-or-email-marketing-destinations.html?lang=en) | 影片 | 在Adobe Real-time Customer Data Platform(CDP)中以檔案為基礎之目的地設定的逐步說明中取得秘訣。 |
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager as a Cloud Service 基礎**
      ...
      * 復寫代理下的樹複製UI [!UICONTROL 分發] 標籤應視為已過時；計畫於2021年9月30日後遷移。 [了解替代複寫策略](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html?lang=en#tree-activation)。
...
| 已發佈 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2021 年 8 月 | [使用案例配方](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/expand/recipes/recipes.html) | 影片 | 透過這些政府和商業電子簽名範例，加速貴組織的數位工作流程。 |
...
| 已發佈 | 名稱 | 類型 | 說明 |
| ----------| --------- | --------- | --------- |
| 2021 年 8 月 | [搜尋 Adobe Stock 授權記錄](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/searchstock.html) | 影片 | 了解如何以企業Creative Cloud快速搜尋貴組織的Adobe Stock授權記錄。 |
