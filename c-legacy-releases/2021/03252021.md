...
| [客戶活動中心藍圖](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/audience-activation/customer-activity.html?lang=zh-Hant) | 了解外部應用程式如何存取Adobe Experience Platform [!UICONTROL 即時客戶個人檔案]. |
...
| [企業資料探索和報告藍圖](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-exploration/overview.html?lang=zh-Hant) | Experience Platform [!UICONTROL 查詢服務] 允許對資料執行SQL查詢。 了解 [!UICONTROL Data Science Workspace] 如何提供在資料上執行資料探索、資料科學和機器學習工作負載的能力。 |
...
| 2021 年 3 月 5 日 | [使用 API 監控資料擷取](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/data-monitoring.html?lang=zh-Hant#data-ingestion) | 影片 | 了解如何使用Platform的UI和API來監視及追蹤擷取至Adobe Experience Platform的資料。 |
| 2021 年 3 月 5 日 | [從資料庫擷取資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-databases.html?lang=zh-Hant#sources) | 影片 | 此影片會逐步說明如何以順暢且可擴充的方式，將資料從資料庫來源批次內嵌至Adobe Experience Platform的即時客戶個人檔案和Experience Data Lake。 |
| 2021 年 3 月 5 日 | [從 Amazon S3 擷取資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-cloud-storage.html?lang=zh-Hant) | 影片 | 此影片說明如何以順暢且可擴充的方式，輕鬆將雲端儲存服務的資料批次內嵌至Adobe Experience Platform的即時客戶個人檔案和資料湖。 |
| 2021 年 3 月 5 日 | [從 Salesforce CRM 擷取資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-crm.html?lang=zh-Hant) | 影片 | 此影片說明如何以順暢且可擴充的方式，輕鬆將CRM來源的資料批次內嵌至Adobe Experience Platform的即時客戶個人檔案和資料湖。 |
| 2021 年 3 月 5 日 | [從 Adobe Analytics 擷取資料](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=zh-Hant) | 影片 | Adobe Analytics Source Connector可讓您以順暢且可擴充的方式，輕鬆將資料從Adobe Analytics串流至Adobe Experience Platform的即時客戶個人檔案和Experience Data Lake。 |
...
| 2021 年 3 月 5 日 | [Adobe Developer Console匯出Postman詳細資訊](https://experienceleague.adobe.com/docs/platform-learn/tutorials/platform-api-authentication.html?lang=zh-Hant) | 影片 | 了解如何驗證及存取 Experience Platform API。 |
| 2021 年 3 月 5 日 | [了解資料擷取](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/understanding-data-ingestion.html#data-ingestion) | 影片 | 了解Experience Platform的資料擷取功能，讓您將資料匯整至一個開放且可擴充的平台，以管理即時客戶設定檔。 |

## ![圖示](/assets/experience_platform_appicon_24.png) Journey Orchestration {#journey-orch}

運用Adobe Experience Platform聰明地即時預測每個人的需求，以大規模協調不同體驗管道的客戶歷程。
...
* 修正編輯並儲存區段的新擁有者後，區段UI中未反映此新擁有者的問題。 (AN-234502；AN-250970；AN-250286)
...
* 修正非管理員使用者的使用者權限問題：只要使用者的設定檔中至少有一個新增了權限，使用者就應該擁有權限 [!UICONTROL Admin Console]. 新增用戶到設定檔應該只會添加該用戶擁有的權限，而不應該移除他透過其他產品設定檔所獲得的任何權限。 (AN-242723)
...
| 2021 年 3 月 | [使用 GraphQL API 的無頭內容管理](https://experienceleague.adobe.com/?lang=zh-Hant?recommended=ExperienceManager-D-1-2020.1.headless) | 課程 | 探索如何使用AEM GraphQL API和無頭功能來支援外部應用程式中呈現的體驗。 |
...
| 2021 年 3 月 | [版本設定/AEM中的時間扭曲](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/timewarp-feature-video-use.html?lang=zh-Hant) | 影片 | 時間扭曲是 Adobe Experience Manager Sites 的一項功能，可讓作者快速地檢閱過去特定時間的頁面狀態。 |
...
| 2021 年 3 月 5 日 | [在 Adobe Stock 向量插圖中自訂顏色](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/customizecolors.html?lang=zh-Hant) | 影片 | 為包含精美插圖的任何專案增加修飾。在Adobe Stock中尋找完美的向量圖，然後使用Adobe Illustrator將顏色與專案的調色盤比對。 |
