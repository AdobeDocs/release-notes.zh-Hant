...
| 2021 年 3 月 5 日 | [Adobe Developer控制台導出Postman詳細資訊](https://experienceleague.adobe.com/docs/platform-learn/tutorials/platform-api-authentication.html?lang=zh-Hant) | 影片 | 了解如何驗證及存取 Experience Platform API。 |
...
| 2021 年 3 月 | [版本控制/時間變AEM頻](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/timewarp-feature-video-use.html?lang=zh-Hant) | 影片 | 時間扭曲是 Adobe Experience Manager Sites 的一項功能，可讓作者快速地檢閱過去特定時間的頁面狀態。 |
