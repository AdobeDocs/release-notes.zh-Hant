...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2023 年 12 月  | [尋找和設定檔資料的 CJA 尋找](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/connections/cja-lookup-data.html) | 影片 | 了解如何新增尋找資料以尋找和分析資料集，以及規劃和對應關鍵欄位。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
|---------|--------|---------|---------|
| 2023 年 12 月  | [Cloud Manager Assets 效能測試失敗](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23312.html) | 新文章 | 了解資產效能測試失敗並出現未知錯誤的解決方案。 |
| 2023 年 12 月  | [編輯內容時出現效能問題](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23222.html) | 新文章 | 了解在瀏覽器開發人員控制台中編輯內容時疑難排解和解決效能問題。 |
| 2023 年 12 月  | [ [!DNL AEMaaCS] 上缺少 [!UICONTROL 索引管理器] ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23195.html) | 新文章 | 了解 [!DNL AEMaaCS] 中的[!UICONTROL 索引管理器]為什麼不支援檢查索引的大小或狀態，例如 [!DNL AEM Managed Services] 和 [!DNL AEM] 內部部署。 |
| 2023 年 12 月  | [由於授權，遠端  [!DNL DAM]  上的影像未顯示](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23185.html) | 新文章 | 了解如何透過授予[!UICONTROL 已連線資產]必要的權限，在遠端 [!DNL DAM (Digital Asset Management)] 上新增影像。 |
| 2023 年 12 月  | [[!UICONTROL 由於] 不可用錯誤，管道建置 [!DNL Python] 失敗](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23141.html) | 新文章 | 透過建立使用 exec 外掛程式安裝 [!DNL Python 3] 的 [!DNL Maven] 專案，了解修正因 [!DNL Python] 錯誤而導致的[!UICONTROL 管道建置]失敗的解決方案。 |
| 2023 年 12 月  | [取得  [!DNL AEM]  版本  [!DNL Oak-run]  工具的步驟](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23130.html) | 新文章 | 了解如何根據 [!DNL Oak-run] 版本取得 [!DNL AEM] 工具。 |
| 2023 年 12 月  | [點擊左上角的「[!DNL Adobe Experience Manager]」前往主導覽畫面，開啟「[!UICONTROL 資產]」檢視](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23111.html) | 新文章 | 了解何時從[!UICONTROL 資產]內部的位置使用[!UICONTROL 全域導覽]，點擊左上角的 [!DNL Adobe Experience Manager] 前往主導覽畫面，這會開啟[!UICONTROL 資產]檢視而不是主檢視。 |
| 2023 年 12 月  | [前端管道部署破壞了網站](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23070.html) | 新文章 | 了解即使部署成功完成，前端管道也無法成功應用於網站的問題的解決方案。 |
| 2023 年 12 月  | [無法在 [!UICONTROL Assets Essentials] 中建立任務](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23065.html) | 新文章 | 如果您在使用特定資產存放庫的 [!UICONTROL Assets Essentials UI] 時無法建立任務，請了解解決方案。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
|---------|----|----|-----------|
| 2023 年 12 月  | [ [!DNL overflow-y: hidden] 屬性自動到登陸頁面](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23345.html) | 新文章 | 了解在 Adobe Campaign Classic v7 中，如果您無法再捲動已發佈的登陸頁面，請手動從登陸頁面定義中移除 `overflow-y: hidden`。 |
| 2023 年 12 月  | [要求標頭未轉寄到 ACC 中的  [!DNL JSSP] ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23342.html) | 新文章 | 了解您何時發送要求標頭，如果它們傳回空白，則表示它們未轉寄到 [!DNL JSSP]。 |
| 2023 年 12 月  | [使用  [!DNL OOTB]  工作流程管理行動應用程式認證到期通知](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23280.html) | 新文章 | 探索 Adobe Campaign Standard 如何透過其 [!DNL OOTB] 工作流程自動執行行動應用程式認證警報 |
| 2023 年 12 月  | [在公共資源下上傳檔案卡住)](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23329.html) | 新文章 | 了解在 Adobe Campaign Classic v7 中的行銷和中間執行個體基礎結構中，透過公共資源上傳檔案在 90% 時卡住的解決方案。 |
| 2023 年 12 月  | [ACC：MKT (行銷) 伺服器未收到推播通知權仗](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23273.html) | 新文章 | 了解當您遇到 MKT (行銷) 伺服器未收到推播通知權仗的 Adobe Campaign Classic 問題時的解決方案。 |
| 2023 年 12 月  | [ACS：無法使用檔案傳輸活動連線到 Adobe  [!DNL SFTP] ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23272.html) | 新文章 | 當您在使用檔案傳輸/下載活動時遇到無法連接到 Adobe [!DNL SFTP] 的問題時，請了解 Adobe Campaign Standard 中的解決方案。 |
| 2023 年 12 月  | [ORA-01805：日期/時間作業可能發生錯誤](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23316.html) | 新文章 | 了解修正 Adobe Campaign 錯誤的步驟：`ORA-01805: possible error in date/time operation.` |
| 2023 年 12 月  | [ [!DNL ffdaUnicity] 工作流程失敗，並出現  [!DNL ODB-240000]  錯誤](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23307.html) | 新文章 | 了解 [!DNL ffdaUnicity] 工作流程失敗並出現 [!DNL ODB-240000] 錯誤的解決方案。 |
| 2023 年 12 月  | [特定電腦的登入錯誤： [!DNL XTK-170092]  查詢條件的運算式過於複雜。](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23188.html) | 新文章 | 了解如何執行硬快取清除以解決特定於電腦的登入錯誤：XTK-170092 查詢條件的運算式過於複雜。 |
| 2023 年 12 月  | [Campaign： [!DNL PGS-220000] 錯誤：運算子不存在：字元變化 = 整數](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23137.html) | 新文章 | 了解在執行包含警報活動的工作流程時出現 [!DNL PGS-220000 Error] `PostgreSQL: ERROR: operator does not exist: character varying = integer` 錯誤的 [!DNL Campaign Classic v7] 問題的解決方案。 |
| 2023 年 12 月  | [控制面板未顯示所有非開箱即用的表格和正在執行的工作流程) ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23124.html) | 新文章 | 了解為什麼 Campaign 控制面板不顯示所有非開箱即用表格和正在執行的工作流程。 |
| 2023 年 12 月  | [將  [!DNL Adobe Campaign Classic]  從  [!DNL Linux]  7.9 遷移到 8.8：綜合指南](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23123.html) | 新文章 | 按照此全面的分步指南，了解如何將現有 [!DNL Adobe Campaign Classic] 執行個體從 [!DNL Linux®] 7.9 遷移到 [!DNL Linux®] 8.8。 |
| 2023 年 12 月  | [為行銷活動設定多個工作流程的限制](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23013.html) | 新文章 | 了解活動中出現錯誤的原因以及如何將「[!UICONTROL 自然屬性]」調整為 *[!UICONTROL 未指定]* 可以有效解決問題。 |
| 2023 年 12 月  | [[!DNL X-Env-sender] 與 from 網域不同](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23053.html) | 新文章 | 從此詳細指南中了解如何透過檢查正確的外部帳戶的路由來解決當 [!DNL X-Env-sender]AFD 與 from 網域不同時的問題。 |
| 2023 年 12 月  | [客戶無法從自訂綱要中刪除記錄](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23001.html) | 新文章 | 了解如何解決自訂架構中的資料刪除問題。 |
| 2023 年 12 月  | [管道觸發器未處理](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23014.html) | 新文章 | 了解一種快速解決方案，以修正未透過在相關執行個體的每個容器上執行命令來處理的管道觸發器。 |
| 2023 年 12 月  | [行動裝置未&#x200B;*[!UICONTROL 收到 `nmsBroadLogRcp` 中的  [!DNL SMS]  傳遞狀態]*](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23023.html) | 新文章 | 了解如何解決`nmsBroadLogRcp` 中 [!DNL SMS] 傳遞狀態不正確的問題。 |
| 2023 年 12 月  | [傳送電子郵件傳遞/校訂時發生錯誤](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22995.html) | 新文章 | 了解使用部署精靈傳送電子郵件傳遞/校訂時發生錯誤時修正問題的快速指南。 |
| 2023 年 12 月  | [收件匣呈現功能/按鈕在傳遞表單中不可用](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22932.html) | 新文章 | 了解交付表單中收件匣呈現功能/按鈕不可用時的解決方法。 |
| 2023 年 12 月  | [Campaign 中傳遞準備期間存取權限錯誤](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23011.html) | 新文章 | 了解如何解決傳遞準備中的存取限制。您必須將執行個體升級到版本 7.3.4。 |
