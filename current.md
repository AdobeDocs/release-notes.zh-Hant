...
| 2025 年 5 月 | [解決 AEMaaCS 中非管理員使用者的後設資料結構可見度問題](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-26655) | 新文章 | 了解如何解決在 AEM as a Cloud Service (AEMaaCS) – Assets 中，貢獻者或數位資產管理 (DAM) 使用者這類使用者因為缺少結構描述資料夾的讀取權限而無法看到自訂後設資料結構描述，但管理員可以看到的問題。 |
