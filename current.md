...
2025年12月&#x200B;**：**&#x200B;新的[課程](https://experienceleague.adobe.com/en/courses)可在Experience League上取得。 他們提供結構化、由專家建立的學習課程，協助您更快速地建立技能、驗證專業知識，並在Adobe解決方案之間更自信地推進。
...
| 發佈日期 | 應用程式 | 名稱 | 類型 | 說明 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2025 年 11 月 | [!DNL Experience Platform] | [使用Adobe Experience Platform Agent Orchestrator介面](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/ai-assistant/agent-orchestrator-ui) | 影片 | 瞭解如何使用Adobe Experience Platform Agent Orchestrator，透過內容提示、動態物件和多個專用代理程式與Experience Cloud解決方案互動。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
|---------|----|----|-----------|
| 2025 年 11 月 | [AEP：由於缺少`MarketingAction`許可權，無法啟用對象](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28026) | 新文章 | 瞭解當生產目的地的受眾啟用失敗時（即使使用者擁有標準啟用許可權），該問題的解決方案。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2025 年 11 月 | [分類設定作業歷史記錄](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/components/classifications/classification-sets-job-history) | 影片 | 檢視上傳和下載分類集資料的工作歷史記錄。 |
| 2025 年 11 月 | [分類集資料匯入方法](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/components/classifications/classification-sets-data-import-methods) | 影片 | 瞭解使用分類設定匯入分類資料的不同方法，以及一些相關的使用案例。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
|---------|--------|---------|---------|
| 2025 年 11 月 | [為什麼&#x200B;**[!UICONTROL Workspace]** **[!UICONTROL 頁面]**&#x200B;維度顯示超過100個位元組（頁面長度超過100個位元組限制）？](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28067) | 新文章 | 瞭解當&#x200B;**[!UICONTROL 頁面]**&#x200B;維度中列出的頁面似乎包含超過100個位元組的字串值，即使頁面維度有100個位元組的限制時，問題的解決方案。 |
...
| 發佈日期 | 應用程式 | 名稱 | 格式 | 說明 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2025 年 11 月 | [!DNL AEM CS] | [已知使用者個人化](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/personalization/use-cases/known-user-personalization) | 影片 | 瞭解如何根據已知使用者資料（例如購買記錄、CRM資料或收集到的有關使用者的其他資料）個人化內容。 |
| 2025 年 11 月 | [!DNL AEM CS] | [個人化使用案例的即時示範](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/personalization/live-demo) | 影片 | WKND啟用網站上使用中的體驗個人化作業，包含A/B測試、行為鎖定和已知使用者個人化範例。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
|---------|--------|---------|---------|
| 2025 年 11 月 | [在AEMaaCS中驗證登入成功與失敗](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27844) | 新文章 | 瞭解如何在Adobe Experience Manager as a Cloud Service (AEMaaCS)作者環境中驗證成功和失敗的登入嘗試，以及如何識別每次嘗試的來源IP位址。 |
| 2025 年 11 月 | 在AEMaaCS中部署後，[Dispatcher快取已清除並暖機](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28034) | 新文章 | 瞭解問題的解決方案，其中有關哪些頁面會預熱以及它們的選擇方式等詳細資訊，不清楚系統何時在排清後自動啟動快取預熱程式（部署後清除Dispatcher快取）。 |
| 2025 年 11 月 | [AEMaaCS中未套用CDN基本驗證密碼變更](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27925) | 新文章 | 瞭解在Adobe Experience Manager as a Cloud Service (AEMaaCS)中更新CDN基本驗證密碼時，透過修改機密環境變數不會套用新值的問題，因為機密環境變數在部署後不可變。 |
| 2025 年 11 月 | [疑難排解AEM中的內容片段編輯器初始化錯誤](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27909) | 新文章 | 瞭解當嘗試在Adobe Experience Manager as a Cloud Service (AEMaaCS)中編輯預設到新內容片段編輯器的內容片段時無法載入且發生錯誤，*無法初始化應用程式的問題解決方案。* |
| 2025 年 11 月 | [AEM查詢產生器API中的查詢結果不一致](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27833) | 新文章 | 瞭解當使用查詢產生器API執行查詢時，如果使用了非預期的索引，會傳回不一致的結果，此問題的解決方案。 |
| 2025 年 11 月 | [AEM 6.5](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28044)中未自動為非管理員使用者建立Lightbox資料夾 | 新文章 | 瞭解當Lightbox功能在新增資產時未自動為非管理員使用者建立Lightbox資料夾時問題的解決方案。 |
| 2025 年 11 月 | [AEM中的二進位檔累積導致 [!DNL MySQL] 資料夾快速成長](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27829) | 新文章 | 瞭解當AEM內部部署環境中的[!DNL MySQL]資料夾因保留的二進位記錄（二進位記錄）檔案而快速展開並耗用大量磁碟空間時，問題的解決方案。 |
| 2025 年 11 月 | 在AEM Cloud Manager[中，`package-lock.json`管道建置從未釘選的節點/NPM失敗，並遺失](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27922) | 新文章 | 瞭解當`frontend-maven-plugin`中未設定節點和NPM版本，且`package-lock.json`檔案未認可時，管道建置失敗時，AEM Cloud Manager中問題的解決方案。 |
| 2025 年 11 月 | 升級至AEM Service Pack 6.5.22[後， [!DNL Firefox] 適用性表單無法在](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27942)中正確顯示 | 新文章 | 瞭解在升級至Service Pack 6.5.22.0和JDK Update 8u441後，Adobe Experience Manager (AEM) Forms中問題的解決方案，透過iframe內網站頁面存取的最適化表單在[!DNL Firefox]中未正確載入所有面板和欄位。 |
| 2025 年 11 月 | [Cloud Manager部署未反映AEMaaCS`/conf`中的](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27944)中繼資料變更 | 新文章 | 瞭解當`/conf`路徑下的AEM搜尋或中繼資料設定變更（例如新增述詞或群組述詞）在部署後未出現在開發或QA環境的UI中時，AEMaaCS中問題的解決方案。 |
| 2025 年 11 月 | [在AEMaaCS中重新初始化 [!DNL Git] 存放庫，不會中斷Cloud Manager環境](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27978) | 新文章 | 瞭解當一個組織在AEMaaCS中將所有權轉移給另一個組織時，如何移除所有先前的[!DNL Git]存放庫內容並重新初始化[!DNL Git]存放庫。 |
| 2025 年 11 月 | [CDN設定未套用於[!UICONTROL X-Walk]架構的Edge Delivery網站](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28000) | 新文章 | 瞭解在[!UICONTROL X-Walk]設定中使用Adobe Experience Manager (AEM)進行製作和Edge Delivery Services (EDS)進行傳送時，將CDN設定部署至錯誤服務導致無效的問題的解決方案。 |
| 2025 年 11 月 | [Oak LDAP IdentityProvider無法同步AEMaaCS中的使用者和群組](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27863) | 新文章 | 瞭解當Adobe Experience Manager as a Cloud Service (AEMaaCS)中的Oak LDAP `IdentityProvider`無法從外部輕量型目錄存取通訊協定(LDAP)目錄同步處理使用者和群組時，該問題的解決方案。 |
| 2025 年 11 月 | [對篩選器的變更未反映在AEM UI中](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27897) | 新文章 | 瞭解當AEM中群組述詞的變更或新新增述詞未出現在UI中（即使是在成功部署管道後）時，問題的解決方案。 |
| 2025 年 11 月 | [在AEM as a Cloud Service中疑難排解前端管道失敗](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28088) | 新文章 | 瞭解在AEM as a Cloud Service中將完整棧疊管道轉換為僅前端(FE)管道時，由於平台特定的相依性和嚴格的篩選要求會發生建置失敗的問題。 |
| 2025 年 11 月 | [[!DNL Tika] 設定在AEMaaCS-Assets中無法運作](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27615) | 新文章 | 瞭解當雲端環境中忽略自訂[!DNL Tika]設定（例如排除PDF），預設為立即可用(OOTB)設定時，AEMaaCS-Assets中問題的解決方案。 |
| 2025 年 11 月 | 在AEMaaCS中切換至私人GitHub存放庫後[遺失發行分支](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27923) | 新文章 | 瞭解AEMaaCS中問題的解決方案，在使用私人GitHub存放庫設定部署管道時，分支選擇下拉式清單未顯示所有發行分支。 |
| 2025 年 11 月 | [**[!UICONTROL 通用編輯器&#x200B;]**&#x200B;在AEMaaCS](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27935)中載入不正確的AEM作者執行個體 | 新文章 | 瞭解在作者執行個體上存取&#x200B;**[!UICONTROL 通用編輯器]**&#x200B;中的Edge Delivery Services (EDS)索引頁面從其他作者環境載入內容時，AEMaaCS中問題的解決方案。 |
| 2025 年 11 月 | [管道建置失敗，因為AEMaaCS`frontend-maven-plugin`中的快取已過時且過時的](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27902)版本 | 新文章 | 瞭解當管道建置在`UI.frontend`模組執行期間失敗時，AEMaaCS中問題的解決方案。 |
| 2025 年 11 月 | 在AEMaaCS[中使用&#x200B;**[!UICONTROL 內容複製工具]**&#x200B;時，](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27936)複製大型DAM資料夾失敗 | 新文章 | 瞭解當使用&#x200B;**[!UICONTROL 內容複製工具]**&#x200B;在作者環境之間複製大型資料夾失敗時，AEMaaCS中問題的解決方案。 |
| 2025 年 11 月 | 在AEMaaCS中推出AEM後[記錄轉送端點還原](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27945) | 新文章 | 瞭解當轉出後記錄轉送設定恢復為上一個端點時，AEMaaCS中問題的解決方案。 |
| 2025 年 11 月 | [在AEM as a Cloud Service管道組建中解析`StackOverflowError`](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27979) | 新文章 | 瞭解在管道建置期間發生週期性`StackOverflowError`時問題的解決方案。 |
| 2025 年 11 月 | 移轉至[&#x200B; [!DNL CoralUI3]後](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27985)修正RTF編輯器按鈕問題 | 新文章 | 瞭解AEMaaCS中問題的解決方案，當自訂對話方塊和使用者端資料庫從[!DNL CoralUI2]移轉到[!DNL CoralUI3]會導致字型、大小和顏色的RTF編輯器按鈕停止運作。 |
| 2025 年 11 月 | 在Cloud Manager管道中[認可雜湊可見性延遲](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28031) | 新文章 | 瞭解在Cloud Manager中使用私人GitHub存放庫觸發管道時，認可雜湊只會在建置或程式碼品質步驟完成後出現，此問題的解決方案。 |
| 2025 年 11 月 | 在AEMaaCS中建立專用輸出IP時，[網路基礎結構發生例外狀況](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27884) | 新文章 | 瞭解在由於缺少主要區域引數而建立專用輸出IP時，AEMaaCS - Sites中問題的解決方案。 |
| 2025 年 11 月 | AEMaaCS[**[!UICONTROL 中缺少&#x200B;]**&#x200B;產生變數](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27894)按鈕 | 新文章 | 瞭解&#x200B;**[!UICONTROL 內容片段編輯器]**&#x200B;中缺少[!UICONTROL 產生變數]按鈕時，AEMaaCS - Sites中問題的解決方案。 |
| 2025 年 11 月 | [在AEMaaCS錯誤回應(404/500)中保留`X-Correlation-Id`](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27918) | 新文章 | 瞭解當`X-Correlation-Id`404 Not Found *或* 500 Internal Server Error *錯誤回應中缺少*&#x200B;標頭時(即使AEM記錄檔確認已設定)，AEMaaCS中問題的解決方案。 |
| 2025 年 11 月 | [AEM部署管道失敗，因為OSGi設定屬性無效](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27930) | 新文章 | 瞭解當中繼和生產環境中的部署管道在執行數小時的&#x200B;**[!UICONTROL 更新服務]**&#x200B;子步驟期間失敗時，AEMaaCS中問題的解決方案。 |
| 2025 年 11 月 | 由於遺失OSGi組合，[AEM部署後RDE服務中斷](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27376) | 新文章 | 瞭解將程式碼部署到AEMaaCS RDE （快速開發環境）環境時，當第三方OSGi套件組合（如`io.jsonwebtoken`）因更嚴格的API區域限制而無法解決時導致服務中斷問題的解決方案。 |
| 2025 年 11 月 | [瞭解AEM時間軸中的相對和絕對日期](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27917) | 新文章 | 瞭解AEMaaCS - Sites中，當[!UICONTROL 時間軸]功能以相對格式（如「3天前」）或絕對格式（如「7/2/25， 2:33下午」）顯示日期時，問題的解決方案。 |
| 2025 年 11 月 | [AEM錯誤記錄檔會顯示無法從 [!DNL Lucene] `MMapDirectory`刪除](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27414)檔案的相關警告 | 新文章 | 瞭解當記錄中的警告訊息指出無法從[!DNL Lucene]刪除`MMapDirectory`個檔案時，Adobe Experience Manager (AEM) Managed Services支援v6.5 （開發）中問題的解決方案。 |
| 2025 年 11 月 | [瞭解AEM中的分割部署管道](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27886) | 新文章 | 瞭解AEM中的分割部署管道如何協助管理環境之間的程式碼提升、其運作方式、為何在Stage上驗證是強制性的，以及在將發行升級至生產環境時該怎麼做。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2025 年 11 月 | [Salesforce Commerce雲端入門套件架構](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/adobe-commerce-optimizer/sfcc-starter-kit/architecture-overview) | 影片 | 瞭解Commerce Optimizer Connector入門套件的架構和功能。 入門套件整合了Salesforce Commerce Cloud (SFCC)和Adobe App Builder。 |
| 2025 年 11 月 | [安裝SFCC卡匣](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/adobe-commerce-optimizer/sfcc-starter-kit/installation-sfcc-cartridge) | 影片 | 瞭解如何為Salesforce Commerce Cloud執行個體安裝和設定Adobe Commerce Optimizer卡匣。 |
| 2025 年 11 月 | [業務成長與Adobe的遠景藍圖](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/webinars-and-events/business-growth/vision-forward) | 影片 | 說明 |
| 2025 年 11 月 | [透過簡化新產品採用來促進企業成長](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/webinars-and-events/business-growth/product-adoption) | 影片 | 瞭解Adobe Commerce如何運用AI工具、模組化採用和更快的開發來簡化雲端移轉，以實現可擴充的業務增長。 |
| 2025 年 11 月 | [雲端自動化修補服務](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/tools/cloud-automation-patching-service) | 影片 | 透過SWAT使用CAPS簡化Adobe Commerce修補作業：自動更新，提供安全、輕鬆的網站維護作業。 |
| 2025 年 11 月 | [使用AI創新的業務成長](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/webinars-and-events/business-growth/ai-innovation) | 影片 | 透過Adobe Commerce探索AI支援的電子商務成長，提升可發現性、最佳化店面，並在全球擴展。 |
...
| 2025 年 11 月 | [雲端基礎結構上Adobe Commerce中的GraphQL忘記密碼速率限制問題2.4.8](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28007) | 新文章 | 瞭解使用GraphQL端點時，忘記密碼功能的速率限制設定未強制執行時的問題解決方案。 |
| 2025 年 11 月 | [解決Adobe I/O中受限制的存取錯誤](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27859) | 新文章 | 瞭解當Adobe I/O中的&#x200B;*限制存取*&#x200B;錯誤阻止開發人員存取&#x200B;**[!UICONTROL 開發人員]**&#x200B;主控台及/或&#x200B;**[!UICONTROL 管理員]**&#x200B;主控台(非Adobe Commerce **[!UICONTROL 管理員]**&#x200B;面板)時，此問題的解決方案。 |
| 2025 年 11 月 | [啟用JS縮制和套件組合時，簽出失敗](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997) | 新文章 | 瞭解在啟用縮制、套件組合和（在某些情況下）合併JavaScript (JS)資產時，結帳功能錯誤時問題的解決方案。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
|---------|----|----|-----------|
| 2025 年 11 月 | [解決Adobe Campaign中行銷與中間來源執行個體之間的隔離差異](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28059) | 新文章 | 瞭解當行銷執行個體顯示比中間來源(RT/MID)執行個體更多隔離的電子郵件地址，並在隔離記錄中造成不一致時，該問題的解決方案。 |
| 2025 年 11 月 | [由於權杖到期，從Snowflake匯出大型檔案在Adobe Campaign中失敗](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27943) | 新文章 | 瞭解在Adobe Campaign工作流程中使用&#x200B;**[!UICONTROL FileExport]**&#x200B;活動從Snowflake匯出大於30 GB的檔案時，該問題的解決方案，匯出失敗並出現錯誤&#x200B;*ODB-240000 ODBC錯誤：由於驗證權杖到期，箭頭區塊下載失敗的最大重試次數已完成*。 |
| 2025 年 11 月 | [與&#x200B;**[!UICONTROL 工作流程高可用性]** (WKFHA)](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27919)相關的選項說明 | 新文章 | 瞭解與Adobe Campaign中的&#x200B;**[!UICONTROL 工作流程高可用性]** (WKFHA)相關的金鑰選項。 |
| 2025 年 11 月 | [無法在Adobe Campaign Managed Cloud中上傳特定字型檔案資源](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27626) | 新文章 | 瞭解當某些檔案型別在Adobe Campaign Managed Cloud中無法成功上傳（即使檔案似乎已上傳至伺服器）時，問題的解決方案。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
|---------|----|----|-----------|
| 2025 年 11 月 | [在Journey Optimizer內容編輯器中使用emoji字元會導致錯誤](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27951) | 新文章 | 瞭解當嘗試在Adobe Journey Optimizer (AJO)的內容編輯器中使用emoji字元時，儲存期間發生錯誤問題的解決方案。 |
| 2025 年 11 月 | [在Adobe Journey Optimizer中未進入歷程的設定檔](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27937) | 新文章 | 瞭解當設定檔未進入歷程時，即使合格事件資料已串流到相關資料集中，問題的解決方案。 |
...
| 發佈日期 | 應用程式 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |---------- |
| 2025 年 11 月 | Acrobat | [使用密碼保護PDF檔案](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/getting-started/password-protect.html) | 影片 | 瞭解如何為您的PDF新增密碼，以保護其他人無法開啟或編輯PDF檔案。 保護您的PDF檔案可防止未經授權的存取、保護敏感資訊、維護檔案完整性，並幫助遵守某些產業法規。 |
| 2025 年 11 月 | Acrobat | [建立可填寫的表單](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/getting-started/create-fillable-forms) | 影片 | 將在InDesign、Microsoft Word、Excel或其他應用程式中建立的紙本掃描表單或檔案，轉換為可填寫的PDF表單。 |
| 2025 年 11 月 | Acrobat | [掃描的檔案](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/accessibility-tutorials/scanned-documents) | 影片 | 瞭解如何在Acrobat Pro中存取掃描的檔案。 掃描的PDF可能比較棘手，但使用正確的工具和技術，您就能讓掃描的PDF變得容易閱讀及存取。 |
| 2025 年 11 月 | Acrobat | [壓縮及最佳化PDF](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/advanced-tasks/reduce) | 影片 | 瞭解如何壓縮和最佳化PDF檔案的大小。 壓縮PDF可讓您更輕鬆地透過電子郵件共用或上傳至有檔案大小限制的網站。 您還可以透過最佳化PDF來增強觀看體驗並節省儲存成本。 |
| 2025 年 11 月 | Acrobat | [移除敏感資訊](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/advanced-tasks/redact) | 影片 | 瞭解如何從PDF中永久移除私人或敏感資訊。 |
| 2025 年 11 月 | Acrobat | [紙張到PDF](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/getting-started/scan-and-ocr) | 影片 | 瞭解如何將紙質檔案轉換為智慧型、可搜尋、可編輯的PDF檔案。 |
