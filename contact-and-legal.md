---
description: 可協助您聯絡Adobe並瞭解使用本產品與檔案的相關法律問題的資訊。
...
可協助您聯絡Adobe並瞭解使用本產品與檔案的相關法律問題的資訊。
...
根據您的解決方案設定，本文件中說明的某些選項可能無法使用。 由於每個帳戶都是獨一無二，因此請參閱您的合約，以瞭解價格、到期日、條款及條件。 如果您想要新增或變更服務層級，或有關於目前服務的疑問，請聯絡您的客戶經理。
...
<ul class="simplelist"> 
 <li> © 2016年Adobe All rights reserved. </li> 
 <li> Published by Adobe Systems Incorporated. </li> 
</ul>

[使用條款](https://www.adobe.com/go/marketingcloud_terms_of_use) | [隱私中心](https://www.adobe.com/tw/privacy/policy.html)
