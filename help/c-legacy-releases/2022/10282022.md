...
>[!IMPORTANT]
>
>請經常回來查看，持續了解 Experience League 的最新消息。 下一次優先產品更新將在假期過後的 **2023 年 1 月** 部署。 請密切關注！
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 12 月 | [增強安全性](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/enhancing-security.html?lang=zh-Hant) | 已更新的影片 | 瞭解公司設定中的安全管理員設定如何控制Adobe Analytics的存取。 這包括增強式密碼、密碼到期和復原功能，以及電子郵件網域限制。 |
| 2022 年 12 月 | [將 Analysis Workspace 專案設為您的登陸頁面](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/setting-an-analysis-workspace-project-as-your-landing-page.html?lang=zh-Hant) | 已更新的影片 | 了解讓新手使用者對工作區分析專案資料輕鬆入門的有效方式。 |
| 2022 年 12 月 | [自訂 Reports and Analytics 中的選單](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/customizing-the-menu-in-reports-and-analytics.html?lang=zh-Hant) | 已更新的影片 | 了解如何為貴組織中的使用者自訂 Reports &amp; Analytics 選單。 這有助於使用者尋找他們最常使用的報告。 |
| 2022 年 11 月 | [什麼是分析？](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/what-is-analytics.html?lang=zh-Hant) | 文章 | 在學習 Adobe Analytics 之前了解分析的基礎知識。 |
| 2022 年 11 月 | [建立儀表板的自訂詳細資料檢視](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/additional-tools/analytics-dashboards/create-custom-detail-views.html?lang=zh-Hant) | 影片 | 了解如何自訂詳細資料檢視，包括 Adobe Analytics 儀表板的文字，以調整想要透過行動計分卡專案向利害關係人講述的故事。 |
| 2022 年 11 月 | [關鍵量度摘要視覺效果](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/key-metric-summary.html?lang=zh-Hant) | 影片 | 瞭解Analysis Workspace中的關鍵量度摘要視覺效果，其可讓您檢視一項重要的量度在單一時間範圍內的趨勢分析。 也能讓您比較兩個時間範圍內的量度成效。 |
...
* 提供進階個人化與分段，這要歸功於大多數對話框欄位上的 [Campaign 變數的插入](https://github.com/adobe/aem-core-email-components/wiki/RTE-Personalization)以及彈性的[分段元件](https://github.com/adobe/aem-core-email-components/wiki/)。
...
| 發佈日期 | 名稱 | 類型 | 說明 | 應用程式 |
| -----------| ---------- | ---------- | ---------- | ------|
| 2022 年 12 月 | [持續的 GraphQL 查詢](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/headless/graphql-api/persisted-queries.html?lang=zh-Hant) | 影片 | 了解如何在 Adobe Experience Manager as a Cloud Service 中保留 GraphQL 查詢，以期將效能最佳化。 | AEM CS |
| 2022 年 12 月 | [篩選 React 應用程式程式碼範例](https://experienceleague.adobe.com/landing/experience-manager/headless/developer/code/fitlering-react-app.html) | 影片 | 簡易的 React 應用程式，可顯示使用內容片段模組化的 WKND Adventures。 | AEM Headless 開發人員入口網站 |
| 2022 年 12 月 | [基本 React 應用程式](https://experienceleague.adobe.com/landing/experience-manager/headless/developer/code/basic-react-app.html?lang=zh-Hant) | 影片 | 了解如何使用 AEM 的 GraphQL API 透過持續性查詢來查詢內容。 此應用程式會呈現 WKND Adventures 的可篩選內容，並在選取冒險後顯示冒險的完整詳細資訊。 | AEM Headless 開發人員入口網站 |
| 2022 年 12 月 | [篩選 jQuery 和 Handlebars 程式碼範例](https://experienceleague.adobe.com/landing/experience-manager/headless/developer/code/filtering-jquery-handlebars.html?lang=zh-Hant) | 影片 | 探索 AEM Headless GraphQL API 使用 jQuery 和 Handlebars 的 JavaScript 應用程式篩選資料的能力。 此應用程式會建立一個可按活動類型篩選的 WKND Adventures 清單。 | AEM Headless 開發人員入口網站 |
| 2022 年 12 月 | [URL 重新導向](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/administration/url-redirection.html?lang=zh-Hant) | 影片 | 了解在 AEM 中執行 URL 重新導向的各種選項。 | AEM 學習 |
| 2022 年 11 月 | [在您的 AEM 專案中包含第三方套件組合](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/creating-your-first-osgi-bundle/include-third-party-jars.html?lang=zh-Hant) | 影片 | 在您的 AEM 專案中包含第三方 OSGi 套件組合。 | AEM Forms |
| 2022 年 11 月 | [使用 ECMA 指令碼產生含片段的 PDF 文件](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/using-fragments-in-output-service-watched-folder.html?lang=zh-Hant) | 影片 | 了解如何使用輸出服務產生使用 XDP 片段的 pdf 檔案。 | AEM Forms |
| 2022 年 11 月 | [產生使用片段的 pdf 文件](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/using-fragments-in-output-service.html?lang=zh-Hant) | 影片 | 了解如何使用輸出服務產生使用 SDP 片段的 pdf 檔案。 | AEM Forms |
| 2022 年 11 月 | [擷取繫結資料並將其儲存在字串變數中](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/custom-workflow-steps/save-submitted-data-in-string-variable.html?lang=zh-Hant) | 影片 | 了解如何將提交的資料包含在電子郵件內文中。 | AEM Forms |
| 2022 年 11 月 | [AEM-CIF 核心元件和 Experience Platform 整合](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/content-and-commerce/integrations/aep.html?lang=zh-Hant) | 影片 | 了解如何使用 CIF - Experience Platform Connector，將店面活動資料從 AEM 呈現的產品頁面傳送到 Experience Platform。 | AEM CS |
...
* 請參閱[Adobe Commerce 和 Magento Open Source 版本注意事項](https://experienceleague.adobe.com/docs/commerce-operations/release/notes/overview.html?lang=zh-Hant)以取得最新資訊。
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 11 月 | [安全性與合規性指南](https://experienceleague.adobe.com/docs/commerce-operations/security-and-compliance/overview.html?lang=zh-Hant) | 產品文件 | 深入了解 Adobe Commerce 中的銷售和促銷功能，包括有針對性的折扣和活動。 |
| 2022 年 10 月 | [Adobe Commerce 支援知識庫](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/overview.html?lang=zh-Hant) | 支援文件 | 支援故障排除和最佳作法、發佈公告、回答常見問題，並強調官方文件 (出於任何原因) 未提及的特定案例。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | --------- | ---------- |
| 2022 年 11 月 | [使用條件規則產生器建立動態內容](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/personalize-content/create-dynamic-content.html?lang=zh-Hant) | 影片 | 了解如何建立和儲存條件規則，以及如何將這些條件規則套用至所有管道的內容。 |
...
| 功能 | 說明 |
| ------- | ----------- |
| 交易 | 「[!UICONTROL 庫存] > [!UICONTROL 交易]」檢視現在包含「[!UICONTROL 交易健康情況]」欄，可顯示每個私人交易的健康情況：「[!UICONTROL 成功]」、「[!UICONTROL 警告]」、「[!UICONTROL 嚴重]」或「[!UICONTROL 無法使用]」。 您可以按一下狀態來查看更多詳細資料，包括交易未按預期執行或支出的原因以及解決潛在問題的步驟。 |
...
| 功能 | 說明 |
| ------- | ----------- |
| 行銷活動、Bulksheet、報告 | ([!DNL Microsoft® Advertising] 帳戶；11 月 15 日發布) 對 [!DNL Microsoft® Audience Network] 上行銷活動的支援已移出 Beta 版。<ul><li>您可以在「[!UICONTROL 行銷活動]」檢視中使用 Bulksheet 建立、編輯和變更客群行銷活動的狀態 (行銷活動類型「[!UICONTROL 客群 (圖片)]」或「[!UICONTROL 客群 (摘要)]」)、廣告群組 (廣告群組類型「[!UICONTROL 客群]」) 和廣告 (創意類型「[!UICONTROL 回應式廣告]」)。</li><li>您現在可以在「[!UICONTROL 行銷活動]」檢視中，檢視現有客群行銷活動，以表格和趨勢圖表格式呈現成效資料。 廣告層級的成效資料也可在報告和 Adobe Analytics 中使用 (適用於與 [!DNL Analytics] 整合的廣告商)。</li></ul>您可以在標準或混合專案組合中包含客群行銷活動。 |
|  | ([!DNL Microsoft® Advertising] 帳戶；11 月 15 日發布) 對多媒體廣告的支援已移出 Beta 版。 您可以在「[!UICONTROL 行銷活動]」檢視中使用 Bulksheet，在搜尋行銷活動中建立和管理多媒體廣告。 廣告具有創意型別「[!UICONTROL 多媒體廣告]」。<br><br>您可以將含多媒體廣告的行銷活動包含在，含有任何支出策略的標準產品組合或混合產品組合中，但[!UICONTROL 目標曝光比重] （混合產品組合尚未支援）除外。<br><br>您可以在[!UICONTROL 行銷活動]檢視中，檢視現有對象行銷活動，其成效資料以表格和趨勢圖表格式。 廣告層級的成效資料也可在報告和 [!DNL Analytics] 中使用 (適用於與 [!DNL Analytics] 整合的廣告商)。 |
| [!UICONTROL 客群]、[!UICONTROL 報表] | ([!DNL Microsoft® Advertising] 帳戶；11 月 29 日發布) 對動態再行銷客群的支援已移出 Beta 版。<ul><li>您的動態再行銷客群已同步並可在「[!UICONTROL 行銷活動] > [!UICONTROL 客群]與 [!UICONTROL 客群類型]」「[!UICONTROL 動態再行銷]&lt;*訪客類型*>」(例如「動態再行銷過往買家」)。 您也可以建立、更新及刪除動態再行銷客群。</li><li>您可以使用客群作為行銷活動層級和廣告群組層級的廣告目標及排除客群。 目標可包含競標修飾詞。**注意：動態再行銷對象目標的**&#x200B;競標修飾詞未在具有「[!UICONTROL 自動最佳化競標調整值]」設定的組合中進行最佳化。</li><li>「[!UICONTROL 客群目標報表]」提供動態再行銷客群的相關資料。</li></ul> |
| [!UICONTROL 匯入行銷活動] | (11 月 15 日發布) 將 [!DNL Google Ads] 行銷活動匯入 [!DNL Microsoft Advertising] 的所有選項已移出 Beta 版：<ul><li>將 [!DNL Google Display Network] 行銷活動匯入 [!DNL Microsoft Audience Network] 上的 [!DNL Microsoft Advertising] 客群行銷活動。</li><li>將 [!DNL Google Ads] 最高成效行銷活動 (包括地區庫存廣告) 匯入 [!DNL Microsoft Advertising] 智慧購物行銷活動。</li><li>(已移出 Beta 版) 將 [!DNL Google Ads] 搜尋和多媒體行銷活動匯入 [!DNL Microsoft Advertising] 搜尋和多媒體行銷活動。</li></ul>從「[!UICONTROL 搜尋] > [!UICONTROL 工具] > [!UICONTROL 匯入行銷活動]」匯入行銷活動後，您可以檢查匯入工作的狀態、檢閱任何錯誤記錄檔，以及編輯、暫停或刪除匯入排程。 |
...
| 2022 年 11 月 | [使用 D-Trust 註冊和簽名](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/digital-id/dtrust/d-trust.html?lang=zh-Hant) | 影片 | 解如何使用 D-Trust 註冊您的身份，然後在文件上使用 D-Trust 數位簽名。 | Acrobat Sign |
| 2022 年 11 月 | [新管理員入門](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/get-started-admin.html?lang=zh-Hant) | 影片 | 在這個全方位影片指南中，了解讓您的組織正常運行所需的所有工具。 | Acrobat Sign |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 11 月 | [令人驚嘆的數位資產](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/stunning-digital-assets.html?lang=zh-Hant) | PDF | 透過此實作教學課程，了解如何將 Adobe Stock 與 CC Libraries 整合在一起，讓平面和畫面設計結果具一致性和專業度。 |
| 2022 年 11 月 | [使用 CC Libraries 改進 CC 工作流程](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/cceoverview/ccetutorials/cc-workflows-cc-libraries.html?lang=zh-Hant) | PDF | 透過此實作教學課程，了解 Creative Cloud Libraries 如何將設計元素保持在一起，確保設計師和團隊的專案具一致性。 |
| 2022 年 11 月 | [使用 Frame.io 進行影片審查](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/videooverview/videotutorials/video-review-frame-io.html?lang=zh-Hant) | PDF | 透過此實作教學課程，了解 Adobe Premiere Pro 的 Frame.io 擴充功能如何讓您集中和共享資源、接收即時評論、追蹤修訂並更快獲得核准，不會延誤時間。 |
