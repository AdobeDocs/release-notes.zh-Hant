...
| [!UICONTROL Status] 首頁的個人化檢視 | <ul><li>介紹「[!UICONTROL 概觀]」頁面上的新檢視：「**[!UICONTROL 我的事件]**」。這個檢視會根據使用者權利和訂閱來篩選事件。</li><li>權利可以是組織或個人權利。訂閱可以是產品或事件訂閱。</li></ul> |
...
* **Experience Manager as a Cloud Service**
  ...
  觀看 [2022 年 1 月版本概觀影片](https://video.tv.adobe.com/v/340120)，了解 2022.1.0 (2022 年 1 月) 版本新增功能摘要。
...
* **Experience Manager GEM 網路研討會：_使用 Experience Manager Headless 和 App Builder 更快建立網站_**
  ...
  **時間**：上午8:00 (PST)或5:00 (CET)或9:00 (IST)
...
| 2022 年 2 月 | [將字體嵌入於產生的 pdf](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/developing-for-cloud-service/intellij-set-up.html#add-the-fonts-module) | 文章 | 了解如何安裝 [!DNL IntelliJ] 社群版。 | AEM Forms CS |
...
| 2022 年 2 月 | [產品推薦](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/content-and-commerce/storefront/authoring/product-recommendations.html?lang=zh-Hant) | 影片 | 了解如何在 Adobe Experience Manager (AEM) 電子店面中動態插入這些產品推薦。Adobe Commerce的推薦引擎功能由Adobe AI提供技術支援。 | AEM 和 Adobe Commerce |
...
* （新增！） [Campaign Standard 22.1版本](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html?lang=zh-Hant)
