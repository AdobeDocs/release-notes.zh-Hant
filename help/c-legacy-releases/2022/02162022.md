...
* Adobe Status 現在於產品等級報告事件。Status「雲端」和「產品」頁面有新外觀，以及根據產品等級事件報告的增強型篩選器。這可讓您在 [status.adobe.com](https://status.adobe.com/zh-tw/) 以及電子郵件通知中更輕鬆地了解您的產品如何受影響。如果您尚未訂閱，請使用此連結來設定個人化的訂閱偏好設定 [https://status.adobe.com/zh-tw/proactive-notifications/manage](https://status.adobe.com/zh-tw/proactive-notifications/manage)
...
| 2022 年 2 月 | [將字體嵌入於產生的 pdf](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/developing-for-cloud-service/intellij-set-up.html?lang=zh-Hant#add-the-fonts-module) | 文章 | 了解如何安裝 [!DNL IntelliJ] 社群版。 | AEM Forms CS |
