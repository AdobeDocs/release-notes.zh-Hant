...
# Experience Cloud 發行說明 - 2022 年 8 月
...
觀看 [2022 年 7 月版本概觀影片](https://video.tv.adobe.com/v/3454207/?captions=chi_hant&quality=12)，以瞭解 2022.7.0 (2022 年 7 月) 版本新增的功能摘要。<!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
* **轉換成 PDF/A - Experience Manager 工作流程步驟** - PDF/A 是用於長期保存文件內容的封存格式，所有字體全都嵌入且檔案都未壓縮。 現在您可以使用轉換成 PDF/A 步驟 (AEM 工作流程) 將任何格式的文件或檔案轉換成 PDF/A 格式。
...
* `mod_macro`現在可在Experience Manager as a Cloud Service中使用。[如需支援的Apache模組清單，請參閱此表格](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html?lang=zh-Hant)。
...
* Experience Manager as a Cloud Service 現在與 Unified Shell 整合，以改進使用者體驗，並將其與所有其他 Experience Cloud 應用程式統一。 請參閱 [Unified Shell 上的 Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/overview/aem-cloud-service-on-unified-shell.html?lang=zh-Hant)。
...
* Experience Manager as a Cloud Service [2022.7.0 版本更新](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/aem-as-a-cloud-service-2022-7-0-release-update/ba-p/540062?profile.language=zh-Hant#M546)。
* 最後！ 所有您需要的全部 Experience Manager 內容都在 [Experience Manager 社群](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/finally-all-the-aem-content-you-need-all-in-one-place-on-aem/ba-p/460583?profile.language=zh-Hant)上的同一處。
* Adobe Experience Manager [Community Lens 第 1 版](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/adobe-experience-manager-community-lens-1st-edition-august-2022/ba-p/538960?profile.language=zh-Hant)，2022 年 8 月。
...
| 發佈日期 | 名稱 | 類型 | 說明 | 應用程式 |
| -----------| ---------- | ---------- | ---------- | ------|
| 2022 年 8 月 | [AEM as a Cloud Service 2022.7.0 版本更新](https://experienceleague.adobe.com/docs/experience-manager-release-overview-events/aemcsupdates/2022/2022-7-0.html?lang=zh-Hant) | 影片 | 聆聽 AEM 產品團隊的心得，並瞭解最新版 Adobe Experience Manager Assets、Assets Essentials、Sites、Commerce Integration Framework、Forms 和 Cloud Manager 的功能和創新。 | AEM as a Cloud Service |
| 2022 年 8 月 | [AEM Headless 教學課程](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/overview.html?lang=zh-Hant) | 更新文章 | AEM Headless SDK教學課程已更新為使用持續查詢和WKND 2.0。 使用實作教學課程來探索如何使用各種選項並選擇適合您的選項。 | AEM as a Cloud Service |
| 2022 年 8 月 | [Forms CS 和 Microsoft® Power Automate](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/forms-cs-and-power-automate/integrate-formscs-power-automate.html?lang=zh-Hant) | 影片 | 在最適化表格提交時叫用您的電源自動化流程。 | AEM Forms |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 8 月 | [Adobe Commerce 內容和設計手冊](https://experienceleague.adobe.com/docs/commerce-admin/content-design/guide-overview.html?lang=zh-Hant) | 產品文件 | 造訪新產品文件首頁，以瞭解 Adobe Commerce 內容和設計。 |
| 2022 年 8 月 | [目錄服務指南概觀](https://experienceleague.adobe.com/docs/commerce-merchant-services/catalog-service/guide-overview.html?lang=zh-Hant) | 產品文件 | 取得[!UICONTROL 目錄服務]的簡介。 瞭解如何上線和安裝。 |
...
* [Campaign v7.3發行說明](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html?lang=zh-Hant)
* [控制面板7月版本](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html?lang=zh-Hant)
...
| -----------| ---------- | ---------- | ---------- |
|July 2022|[Configure message frequency rules](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/channel-configuration/configure-frequency-rules.html?lang=zh-Hant)|Video |Learn how to create, activate, test, and report on frequency rules. Understand how to determine which frequency rules will be inherited for a message.|
|July 2022|[Configure, author, and deliver SMS messages](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-messages/configure-author-and-deliver-sms-messages.html?lang=zh-Hant)|Video |Learn how to configure, author, and include SMS messaging into your customer journeys.|
|July 2022|[Inbound keyword support for SMS](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-messages/inbound-keyword-support-for-sms.html?lang=zh-Hant)|Video |Understand how native inbound keyword support (start, stop, unstop) for SMS works.|
...
| 發佈日期 | 名稱 | 類型 | 說明 | 應用程式 |
| -----------| ---------- | ---------- | ---------- |---------- |
| 2022 年 8 月 | [全新的工作區體驗](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/getting-started/new-workspace.html?lang=zh-Hant) | 影片 | 瞭解您可以在 Acrobat 中啟用的全新工作區體驗，讓您在工具與檔案之間無縫切換。 | Adobe Acrobat |
...
| 2022 年 8 月 | [使用印章簽名](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-signing/sign-with-a-stamp.html?lang=zh-Hant) | 影片 | 瞭解如何在簽名工作流程中使用印章，以標記文件已核准或完成。 | Acrobat Sign |
