...
* `mod_macro`現在可在Experience Manager as a Cloud Service中使用。[如需支援的Apache模組清單，請參閱此表格](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html)。
