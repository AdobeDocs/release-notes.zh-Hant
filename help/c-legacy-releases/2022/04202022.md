...
| 2022 年 4 月 | [[!DNL Site-Wide Analysis Tool]](https://experienceleague.adobe.com/docs/commerce-operations/tools/site-wide-analysis-tool/intro.html?lang=zh-Hant) | 文件 | 有關[!DNL Site-Wide Analysis]工具的完整資訊，包括其用途、安裝過程和存取許可權。Adobe Commerce |
