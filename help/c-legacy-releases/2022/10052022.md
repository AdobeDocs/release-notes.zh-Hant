...
* [Experience Manager as a Cloud Service 版本更新](https://experienceleague.adobe.com/docs/experience-manager-release-overview-events/aemcsupdates/overview.html) - 取得 Adobe Experience Manager as a Cloud Service 的最新功能快速概觀。
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 10 月 | [內部部署安裝概觀](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/overview.html) | 產品文件 | 了解 Adobe Commerce 和 Magento Open Source 的內部部署的安裝程序。 |
...
| 2022 年 10 月 | [處理來自 Dropbox 的檔案](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/integrations/acrobat-dropbox.html) | 影片 | 了解如何從 Acrobat 內開啟、建立、編輯、簽署及儲存對 Dropbox 檔案的變更。 | Acrobat |
| 2022 年 10 月 | [在 SharePoint 內使用 Power Automate 自動封存檔案](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/auto-archive-sharepoint-power-automate.html) | 影片 | 了解如何使用 Power Automate 將簽名文件自動封存到 SharePoint 文件庫。 | Acrobat Sign |
...
| 2022 年 10 月 | [設定外部封存](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/set-up-your-external-archive.html) | 影片 | 了解如何為已簽署的協議備份複本建立外部封存。 | Acrobat Sign |
| 2022 年 10 月 | [管理並追蹤您的協議](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-managing/manage-and-track.html) | 已更新的影片 | 了解如何在 Acrobat Sign 中管理及追蹤為了索取簽名而傳送的文件。 | Acrobat Sign |
| 2022 年 10 月 | [在 Salesforce 中設定合併對應](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/salesforce/set-up-merging-map.html) | 已更新的影片 | 了解如何將 Salesforce 中的資料直接合併到 Acrobat Sign 文件中。 | Acrobat Sign |
...
| 2022 年 10 月 | [管理網頁表單資料](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/manage-webform-data.html) | 影片 | 了解如何追蹤、管理及匯出網頁表單中的資料。 | Acrobat Sign |
...
| 2022 年 9 月 | [註冊開發人員帳戶](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/oem/sign-up-developer-account.html) | 影片 | 在 _Acrobat Sign 嵌入快速入門指南_&#x200B;的第 1 部分中，了解如何註冊 Acrobat Sign API 開發人員帳戶。 您的新開發人員帳戶已完整啟用簽署和 API 功能。 | 文件服務 |
| 2022 年 9 月 | [建立您的應用程式](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/oem/creating-your-application.html) | 影片 | 在 _Acrobat Sign 嵌入快速入門指南_&#x200B;的第 2 部分中，了解如何使用 Acrobat Sign API 建立應用程式。 | 文件服務 |
| 2022 年 9 月 | [建立嵌入連結](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/oem/creating-an-embed-link.html) | 影片 | 在 _Acrobat Sign 嵌入快速入門指南_&#x200B;的第 3 部分中，了解如何為 OAuth 建立嵌入連結。 您的應用程式將使用此 OAuth 方法為使用者取得權限。 | 文件服務 |
| 2022 年 9 月 | [產生存取權杖](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/oem/generating-an-access-token.html) | 影片 | 在 _Acrobat Sign 嵌入快速入門指南_&#x200B;的第 4 部分中，了解如何產生可與 Acrobat Sign API 一起使用的存取權杖。 | 文件服務 |
| 2022 年 9 月 | [建立暫時性文件](https://experienceleague.adobe.com/docs/document-services/tutorials/acrobatsign/oem/creating-a-transient-document.html) | 影片 | 在 _Acrobat Sign 嵌入快速入門指南_&#x200B;的第 5 部分中，了解如何建立暫時性文件。 | 文件服務 |
