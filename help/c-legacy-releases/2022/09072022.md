...
| [!UICONTROL 廣告洞察] | [!UICONTROL 廣告洞察]檢視具有全新的外觀和工作流程，並以可提高效能和可靠性的新基礎結構為基礎。現在，只需按一下分析名稱，選擇或輸入設定，然後按一下[!UICONTROL 產生洞察]。<br><br>若要臨時返回舊版檢視，請啟用右上角的[!UICONTROL 切換到舊版 UI]。舊版檢視將在 9 月底移除。 |
