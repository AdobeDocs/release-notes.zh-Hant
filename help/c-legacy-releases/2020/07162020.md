...
* 全新標準穩定版。[閱讀全文](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-1.html?lang=zh-Hant#release-19-1-4-build-9032)
...
| Audience Manager 整合 | (僅限使用 Adobe Experience Platform 的 Adobe Audience Manager Beta 版客戶) DSP 可以透過 Adobe Experience Platform 將包含廣告商廣告參與資料的可操作記錄檔傳送到 Audience Manager。在 Audience Manager 中，廣告商可以在洞察工具中使用進階細分和使用情況的資料，例如 Audience Optimization 報告。 |
