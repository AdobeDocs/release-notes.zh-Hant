...
* **Labs (技術預覽)：**&#x200B;這項新的 Analytics 功能可讓您在生產環境中測試新功能的原型，為 Adobe 提供有價值的意見回饋。[更多詳情...](https://experienceleague.adobe.com/docs/analytics/analyze/tech-previews/overview.html)
