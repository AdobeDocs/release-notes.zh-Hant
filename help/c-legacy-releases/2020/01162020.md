...
* 您可以使用 Adobe ID，根據產品、地區和事件偏好設定來訂閱事件通知。完成訂閱偏好設定後，當使用者開啟、更新或關閉產品時，只會收到相關產品事件和維護事件的通知。若要開始設定，請前往 [status.adobe.com/subscriptions](https://status.adobe.com/zh-tw/proactive-notifications/subscriptions/edit)。
...
* **新功能：AEM as a Cloud Service**
  ...
  [Adobe Experience Manager](https://business.adobe.com/tw/products/experience-manager/adobe-experience-manager.html) (AEM) 現在能以 Cloud Service 形式使用。
