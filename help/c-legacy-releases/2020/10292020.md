...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2020 年 11 月 23 日 | [設定檔案式雲端儲存空間或電子郵件行銷目標](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configuring-file-based-cloud-storage-or-email-marketing-destinations.html?lang=zh-Hant#destinations) | 影片 | 在逐步解說如何設定 Adobe 的 Real-time CDP 中以檔案為基礎的目的地時，取得祕訣。 適用於雲端儲存目標 (例如 S3 或 SFTP) 以及電子郵件行銷目標。 |
...
| 2020 年 10 月 29 日 | [Offer Decisioning](https://experienceleague.adobe.com/docs/offer-decisioning-learn/tutorials/demo-of-offer-decisioning.html?lang=zh-Hant) | 影片 | 了解各大品牌如何善用 Adobe 的全新 [!UICONTROL Offer Decisioning] 服務來定義及管理產品建議、運用即時客戶資料，並提供客戶期望的合適體驗。 |
...
| [!UICONTROL 工作區] [!UICONTROL 線條]視覺效果：移動平均趨勢線選項 | 2020 年 10 月 8 日 | 在[!UICONTROL 「線條」]視覺效果趨勢線設定中新增了移動平均。 移動平均也稱為滾動平均，會使用特定數量的資料點 (由[!UICONTROL 期間]選項決定)、求取其平均值，並將平均值作為線條中的點。 [了解更多](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/line.html?lang=zh-Hant) |
...
| 移除回填限制 | 2020 年 10 月 19 日 | 為改善 CJA 體驗，我們已移除回填 (匯入歷史資料) 限制。 過去，您可以自行回填最多 25 億列的資料，若超過這個數字便需有工程技術介入。 現在，您可以自行回填資料，沒有任何限制。 [了解更多](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html?lang=zh-Hant#enable-connection) |
...
| 2020 年 10 月 10 日 | [了解預測客群](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/algorithmic-models/understanding-predictive-audiences.html?lang=zh-Hant) | 影片 | 此影片中，我們會說明何謂 Audience Manager 預測對象、詳細解說其運作方式，並提供使用案例。 |
...
* **發表提交 Experience Manager 功能要求的新程序**
  ...
  您想看看 Experience Manager 藍圖中新增的功能嗎？ Adobe 發表了 *FeatureBit* - 此專案旨在改善客戶和合作夥伴向 Experience Manager 產品團隊要求功能增強 (稱為 RFE) 的方式。 您可以透過 [Experience League AEM 社群](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/announcing-the-new-process-to-submit-experience-manager-feature/td-p/380425?profile.language=zh-Hant)了解詳細資訊。
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2020 年 12 月 2 日 | [下載內容片段](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/content-fragments/content-fragments-feature-video-use.html?lang=zh-Hant) | 影片 | 概觀內容片段下載功能的影片。 |
...
| 2020 年 11 月 10 日 | [設定管理員的 AEM 存取權](https://experienceleague.adobe.com/?lang=zh-hant&recommended=ExperienceManager-A-1-2020.1.aem) | 課程 | 探索使用者如何使用 Adobe IMS 執行 AEM 雲端服務驗證，以及如何使用 Adobe IMS 使用者、使用者群組和產品設定檔來控制 AEM 存取權及其功能。 |
...
| 2020 年 11 月 4 日 | [資產計算中繼資料轉譯](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/advanced/metadata.html?lang=zh-Hant) | 教學課程 | 在「資產計算」教學課程中新增進階章節，其中涵蓋產生中繼資料轉譯。 |
| 2020 年 10 月 21 日 | [組合表單附件](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/assemble-form-attachments.html?lang=zh-Hant) | 影片 | 依特定順序將表單附件組合為一個 PDF。 |
| 2020 年 11 月 2 日 | [建立內容片段](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/content-fragments/content-fragments-feature-video-use.html?lang=zh-Hant) | 影片 | 概觀在 Adobe Experience Manager (AEM) 資產中建立內容片段的影片。 |
| 2020 年 11 月 2 日 | [在網站頁面上使用內容片段](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/content-fragments/content-fragments-delivery-feature-video-use.html?lang=zh-Hant) | 影片 | 了解如何在 AEM Sites 頁面上使用內容片段。 可透過 AEM 的樣式系統來設定內容片段元件的樣式，以便視需求顯示內容。 |
| 2020 年 11 月 2 日 | [樣式系統](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/style-system-feature-video-use.html?lang=zh-Hant) | 影片 | 使用 We.Retail List 元件建立 AEM 6.4 的樣式系統影片。 |
| 2020 年 11 月 2 日 | [載入及觸發 Target 呼叫](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/target/load-and-fire-target.html?lang=zh-Hant) | 影片 | 了解如何使用 Launch 規則將參數載入、傳遞至頁面請求，以及從您的網站頁面觸發 Target 呼叫。 系統會使用 Adobe Client Data Layer 來擷取頁面資訊並以參數形式傳遞，此資料層可讓您收集和儲存訪客的網頁體驗相關資料，並且讓此資料易於存取。 |
| 2020 年 10 月 28 日 | [影片智慧標籤](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/metadata/video-smart-tags.html?lang=zh-Hant) | 影片 | Experience Manager Assets運用Adobe AI，使用可描述影片中關鍵元素的關鍵字，聰明地標籤影片資產，讓AEM使用者能透過關鍵字搜尋輕鬆找到影片。 |
...
| 2020 年 9 月 14 日 | [設定Adobe Developer App Builder](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/set-up/firefly.html?lang=zh-Hant) | 教學課程 | Asset Compute應用程式是特別定義的Adobe Developer App Builder應用程式，因此需要在Adobe Developer Console中存取Adobe Developer App Builder才能設定和部署它們。 |
...
| 2020 年 10 月 19 日 | [控制面板 - 新增 IP 範圍至允許清單](https://experienceleague.adobe.com/docs/campaign-classic-learn/control-panel/sftp-management/adding-ip-range-to-allow-list.html?lang=zh-Hant) | Campaign Classic | 了解如何在控制面板中新增 IP 位址範圍至允許清單。 |
