...
| 2021 年 4 月 | [資料管理的未來和不斷變化的環境 - 事件](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/industry/the-future-of-data-management-and-the-changing-environment.html?lang=zh-Hant#industry) | 文章 | 隨著市場力量改變了數位環境的面貌，企業也需要適應資料控管、身分識別解析及如何使用有意義的內容與潛在客戶和匿名訪客互動的新現實。 |
...
| 2021 年 4 月 | [建立第一個[!UICONTROL 最適化表格]](https://video.tv.adobe.com/v/3424983?captions=chi_hant) | 影片 | 學習如何建立第一個最適化表格。 |
