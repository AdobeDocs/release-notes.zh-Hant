...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2025 年 5 月 | [使用「[!UICONTROL 快速洞察]」面板](https://experienceleague.adobe.com/zh-hant/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/panels/use-the-quick-insights-panel) | 新影片 | 了解如何使用 [!DNL Customer Journey Analytics] 中的「_[!UICONTROL 快速洞察]_」面板，快速輕鬆地回答業務問題。 |
...
| 2025 年 5 月 | [了解報告元件](https://experienceleague.adobe.com/zh-hant/docs/workfront-learn/tutorials-workfront/reporting/basic-reporting/reporting-components) | 新影片 | 了解報告元件，以透過物件型篩選器、動態視圖、結構化分組及萬用字元功能，改善資料視覺化效果，獲得量身打造的洞察。 |
