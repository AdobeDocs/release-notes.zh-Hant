---
title: 中央發行說明 — 2023年11月
description: 找到 Adobe  [!DNL Experience Cloud]  產品和服務的最新發行說明。 了解 Experience League 即將舉辦的活動和新文件。 探索  [!DNL Experience Cloud]  應用程式的最新教學課程和其他課程。
...
呼叫所有 AEM 愛好者！ 參加 11 月 6 日 (歐洲、中東和非洲、拉丁美洲、北美洲) 和 11 月 15 日 (亞太地區) 舉行的 Adobe Developers Live，以了解獨家的 AEM 洞察並進行互動交流。 探索最新的 AEM 進展，與業界專家互動，並在 AEM 社群內建立人脈。 不要錯過這個提升專業知識的機會！
