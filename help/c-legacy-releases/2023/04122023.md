...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2023 年 4 月 | [Adobe Developer App Builder](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-developer-app-builder/first-app/overview.html?lang=zh-Hant) | 影片 | 了解如何使用 [!DNL App Builder] 並與您的 Adobe Commerce 網站進行通訊。 新的教學課程影片可協助建置您的第一個 [!DNL App Builder] 應用程式。 |
| 2023 年 4 月 | [Experience Platform 連接器事件](https://experienceleague.adobe.com/docs/commerce-merchant-services/experience-platform-connector/event-forwarding/events.html?lang=zh-Hant) | 產品文件 | 新增有關 Experience Platform 連接器的 [B2B 事件](https://experienceleague.adobe.com/docs/commerce-merchant-services/experience-platform-connector/event-forwarding/events.html?lang=zh-Hant#b2b-events)和[後台](https://experienceleague.adobe.com/docs/commerce-merchant-services/experience-platform-connector/event-forwarding/events.html?lang=zh-Hant#back-office-events)事件的文件。<p> [深入了解...](https://experienceleague.adobe.com/docs/commerce-admin/b2b/release-notes.html?lang=zh-Hant) |
...
| 2023 年 4 月 | [設定登陸頁面](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/landing-pages/configure-landingpages.html?lang=zh-Hant) | 影片 | 了解如何建立並設定登陸頁面。 | Campaign v8 |
...
| 2023 年 4 月 | [傳送電子郵件傳遞的校樣](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/communication-channels/email/sending-test-preparing-sending-email.html?lang=zh-Hant) | 影片 | 了解如何先測試電子郵件訊息，再傳送給最終收件者。 | Campaign v8 |
