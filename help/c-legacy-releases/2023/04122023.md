...
* Assets 報告現在可讓管理員從 [!DNL Experience Manager Assets] as a [!DNL Cloud Service] 部署[產生資產下載報告](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/admin/asset-reports.html)。此資料可進一步讓管理員從關鍵成功量度取得洞察，以衡量企業內和客戶對資產的採用程度。
