...
| 2024 年 7 月 | [解鎖衍生欄位的進階洞察](https://experienceleague.adobe.com/zh-hant/docs/customer-journey-analytics-learn/tutorials/data-views/use-the-next-previous-function-in-derived-fields) | 影片 | 了解如何使用 Customer Journey Analytics 的&#x200B;**[!UICONTROL 下一個或上一個]**&#x200B;函數建立複雜的衍生欄位以增強資料分析。 |
...
| 2024 年 7 月 | [功能參與度分析](https://experienceleague.adobe.com/zh-hant/docs/customer-journey-analytics-learn/tutorials/guided-analysis/feature-matrix/feature-engagement) | 影片 | 了解如何使用 Adobe Product Analytics 中的功能參與度視圖。 此分析提供有關產品功能的使用頻率與使用人數的洞察。 同時比較多個功能以獲得最佳效益。 |
...
| 2024 年 6 月 | [[!DNL AEMaaCS]：如何使用管理員權限存取預覽層級的存放庫瀏覽器](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-24457) | 新文章 | 瞭解如何使用自訂工作流程顯示所有節點，因為依預設，預覽層的存放庫瀏覽器不會顯示（例如，`/conf`、`/home`和`/var`下的節點是隱藏的）。 所有節點。 |
...
| 2024 年 6 月 | [Adobe Commerce 支援接收程序移轉至  [!DNL Experience League]](https://experienceleague.adobe.com/zh-hant/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/adobe-commerce-support-intake-process-migration) | 新文章 | 我們很高興地宣佈，在我們的歷程中，為了更密切地連線至Adobe解決方案系列，Adobe Commerce正在將我們的支援接收程式從Adobe Commerce說明中心移轉至Adobe [!DNL Experience League]，日期為2024年7月15日。[!DNL Experience League] 目前是Adobe Commerce自助檔案、使用手冊及最佳作法的首頁。 它將成為滿足所有支援需求的主要資源，從自助服務到專員通訊都包含在內。 感謝您理解並支持我們進行這項重要轉變。 |
...
| 2024 年 7 月 | Acrobat | [使用 AI 助理發現 PDF 洞察](https://experienceleague.adobe.com/zh-hant/docs/document-cloud-learn/acrobat-learning/getting-started/ai-assistant) | 影片 | 了解如何使用 AI 助理從 PDF 檔案中取得洞察，從而快速建立具影響力的內容。 AI 助理是一種安全的對話式引擎，可改善文件工作流程並分析複雜的文件資料。 |
