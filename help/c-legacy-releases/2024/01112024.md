...
在Experience League上檢視所有[即將舉辦的活動](https://experienceleague.adobe.com/en/events)或瀏覽[活動錄製](https://experienceleague.adobe.com/zh-hant/docs/events/experience-league-recorded-events/overview)。
...
| 發佈日期 | 應用程式 | 名稱 | 類型 | 說明 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2023 年 12 月 | Mobile SDK | [在行動應用程式教學課程中實作 Adobe Experience Cloud](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/overview) | 更新教學課程 (多篇文章) | 了解如何使用 Adobe [!DNL Experience Platform Mobile SDK] 在您的行動應用程式中實作 Adobe [!DNL Experience Cloud] 應用程式。 |
| 2023 年 12 月 | 平台、Journey Optimizer | [建立並傳送推播通知](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-push) | 文章 | 了解如何使用 [!DNL Experience Platform Mobile SDK] 和 [!DNL Journey Optimizer] 為行動應用程式建立推播通知。 |
| 2023 年 12 月 | Mobile SDK、Journey Optimizer | [建立和傳送應用程式內訊息](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-inapp) | 文章 | 了解如何使用 [!DNL Experience Platform Mobile SDK] 和 [!DNL Journey Optimizer] 為行動應用程式建立應用程式內訊息。 |
| 2023 年 12 月 | 平台、Journey Optimizer | [使用決策管理建立和顯示產品/服務](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-offers) | 文章 | 了解如何使用 [!DNL Experience Platform Mobile SDK] 在您的行動應用程式中顯示來自 [!DNL Journey Optimizer] [!UICONTROL 決策管理]的產品/服務。 |
| 2023 年 12 月 | 管理 | [新增產品管理員](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/admin/add-product-administrators) | 影片 | 了解如何在 [!DNL Admin Console] 中為 Adobe [!DNL Experience Platform] 新增管理員。 管理員可以新增和管理其他管理員、使用者、開發人員和 API 認證。 |
| 2023 年 12 月 | 管理 | [新增開發人員並授予 API 認證權限](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/admin/add-developers) | 影片 | 了解如何將開發人員新增至以 Adobe Experience Platform 為基礎的應用程式 (例如 [!DNL Real-Time Customer Data Platform] 和 [!DNL Journey Optimizer])。 |
| 2023 年 12 月 | 管理 | [新增使用者並管理權限](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/admin/add-users) | 更新的影片 | 了解如何在以 Adobe Experience Platform 為基礎的應用程式中新增使用者和管理權限 (例如 [!DNL Real-Time Customer Data Platform] 和 [!DNL Journey Optimizer])。 |
| 2023 年 12 月 | 資料彙集 | [建立資料流](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/initial-configuration/create-datastream) | 影片 | 了解如何在 Experience Platform 中建立資料流。 |
| 2023 年 12 月 | 資料彙集 | [設定標記屬性](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/initial-configuration/configure-tags) | 影片 | 了解如何在[!UICONTROL 資料收集]介面中設定標記屬性。 |
...
| 2023 年 12 月 | 輪廓 | [建立購買總和的計算屬性](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/profiles/create-a-computed-attribute-for-sum-of-purchases) | 影片 | 了解如何使用計算屬性來加總使用者在多個銷售管道中購買的金額。 |
| 2023 年 12 月 | 資料彙集 | [建立標記屬性](https://experienceleague.adobe.com/en/docs/platform-learn/data-collection/tags/create-a-property)。 | 更新的影片 | 了解如何建立標記屬性以管理網站上的行銷標記。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
|---------|----|----|-----------|
| 2023 年 12 月 | [[!DNL AEP] - [!DNL TARGET] 客群 - 在  [!DNL AEP] 中單次啟動後，所有  [!DNL Target]  客群的修改日期都會變更](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23223) | 新文章 | 了解為什麼您可能會看到在 [!DNL Adobe Experience Platform] 中啟動單一區段後，[!DNL Target] 目的地 ([!DNL Target UI] 內) 中所有已啟動區段的修改日期都會發生變化。 |
| 2023 年 12 月 | [[!DNL AEP] - 當來源結構描述不符合 [!DNL XDM] 時，串流輪廓更新會失敗](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23026) | 新文章 | 了解當串流傳輸輪廓「[!DNL upsert]」時，如果來源結構描述不符合 [!DNL XDM]，則資料流會失敗。 |
| 2023 年 12 月 | [[!DNL AEP] - 授權使用區段中的可尋址客群與首頁中的輪廓計數不相符](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23025) | 新文章 | 瞭解授權使用區段中的可尋址客群何時與首頁中的輪廓計數不相符。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| ----------| ---------- | ---------- |---------- |
| 2023 年 12 月 | [將範例資料匯入 Adobe [!DNL Experience Platform]](https://experienceleague.adobe.com/en/docs/platform-learn/tutorials/import-sample-data) | 已更新的文章 | 瞭解如何設定包含範例資料的 Experience Platform 沙箱環境。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2024 年 1 月 | [在 [!UICONTROL Analysis Workspace] 中共用唯讀專案](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/view-only-projects-in-analysis-workspace) | 影片 | 了解如何與使用者共用唯讀 [!UICONTROL Workspace] 專案，並了解此權限等級可用的功能。 |
| 2023 年 12 月 | [可協助稽核資料字典的檢查清單](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/administration/admin-tips/audit-your-data-dictionary) | 文章 | 使用我們的 Adobe [!DNL Analytics] 和 [!DNL Customer Journey Analytics] [!UICONTROL 資料字典]稽核清單來提高資料效率和可靠性。 |
| 2023 年 12 月 | [轉換變數 (eVar) 簡介](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/analysis-workspace/dimensions/introduction-to-conversion-variables-evars) | 影片 | 了解如何在 Adobe [!DNL Analytics] 中使用轉換變數 (也稱為 eVar)，包括其與轉換事件的關係以及與流量變數的差別。 |
| 2023 年 12 月 | [Experience Platform 標記中 Analytics 擴充功能的基本設定](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/basic-configuration-of-the-analytics-launch-extension.html) | 影片 | 觀看如何在基本網站的 [!DNL Experience Platform] 標記中設定 [!DNL Analytics] 擴充功能。 |
| 2023 年 12 月 | [在 Adobe 標記中為 Analytics 擴充功能設定資料庫管理](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/configuring-library-management-in-the-launch-analytics-extension.html) | 影片 | 了解 Experience Platform 標記中 [!DNL Analytics] 擴充功能的資料庫管理設定選項，包括選擇用於資料收集的報告套件。 |
| 2023 年 12 月 | [在 Experience Platform 標記中為 Analytics 擴充功能設定全域變數設定](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/configuring-global-variables-in-the-tags-analytics-extension.html) | 影片 | 了解如何在基本網站的 Analytics 標記擴充功能中設定全域變數設定。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
|---------|----|----|-----------|
| 2023 年 12 月 | [重複購買 ID 導致  [!DNL Adobe Analytics] 中未報告](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-23145) | 新文章 | 了解重複購買 ID 如何影響 [!DNL Adobe Analytics]，從而防止訂購報告。 了解正確的實施如何解決此追蹤問題。 |
| 2023 年 12 月 | [如何手動對  [!DNL Workspace]  報告中的[!UICONTROL 日期範圍維度]順序進行排序？](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-21923) | 新文章 | 了解如果[!UICONTROL 日期範圍]排序圖示無法協助對 [!DNL Adobe Analytics] 中的[!UICONTROL 維度]順序進行排序，該如何解決問題。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2023 年 12 月 | [尋找和輪廓資料的 CJA 尋找](https://experienceleague.adobe.com/en/docs/customer-journey-analytics-learn/tutorials/connections/cja-lookup-data) | 影片 | 了解如何新增尋找資料以尋找和分析資料集，以及規劃和對應關鍵欄位。 |
...
現有客戶可以繼續使用他們實施的 [!DNL DIL]。 然而，Adobe 從該時間點起不會再開發 [!DNL DIL]。 建立客戶針對其長期資料收集策略來評估 [Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/home.html?lang=en)。 若客戶希望在 2023 年 7 月後實施新資料收集整合，他們應該使用 [Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/web-sdk/home.html?lang=en)。

如需自助資源，請參閱 Experience League 上的 [Audience Manager 文件與教學課程](https://experienceleague.adobe.com/en/docs/audience-manager)。
...
除了最近發佈的[流量篩選規則](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/security/traffic-filter-rules-including-waf) (其中包含可以選擇授權的 Web 應用程式防火牆 (WAF) 規則)，也可以使用[!UICONTROL 設定管道]來聲明及部署其他類型的 CDN 設定。 Adobe 希望了解您的使用案例，包括以下內容：
...
* [Cloud Manager 自訂權限](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-permissions)可讓您以可設定的權限建立自訂權限輪廓，以限制 [!DNL Cloud Manager] 使用者對方案、管道和環境的存取。
...
* 建置容器現在支援[前端管道](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/developing/developing-with-front-end-pipelines)的 Node.js 版本 18。
* 對於新建立的 Cloud Manager 計劃，[相關聯的 New Relic 子帳戶](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/user-access-new-relic)預設不會啟動。
...
* [已公告並於 2023 年 10 月版 Cloud Manager 開始](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/cloud-manager/2023/2023-10-0)的[組建環境](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details)更新已完成推出。
   * [前端和全端管道](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines)已新增對 Node 18 的支援。
   * Java™ 8 次要版本已更新為 `jdk1.8.0_371`。
   * Java™ 11 次要版本已更新為 `jdk-11.0.20`。
   * Maven 已更新為版本 3.8.8。
      * Maven 現在預設為停用所有不安全的 `http://*` 鏡像。
      * [Adobe 建議](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/create-application-project/build-environment-details)使用者更新其 Maven 存放庫以使用 HTTPS 而非 HTTP。
...
* [Experience Manager as a Cloud Service目前發行說明](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html)
* [Experience Manager as a Cloud Service發行資訊](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/home.html?lang=zh-Hant)
...
| 2023 年 12 月 | [修改或覆寫核心和第三方 PHP 程式碼的最佳實務](https://experienceleague.adobe.com/docs/commerce-operations/implementation-playbook/best-practices/development/modifying-core-and-third-party-code.html) | 影片 | 當需要修改非您創作或不直接控制的任何程式碼的功能、結果或輸入時，了解最佳實務。 換句話說，核心程式碼和第三方程式碼。 |
...
| 2023 年 12 月 | [區段未評估輪廓，但  [!DNL Journey]  仍然發送了電子郵件](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22975.html) | 新文章 | 了解即使 [!DNL Segment] 尚未評估任何輪廓，[!DNL Journey] 是否也會發送電子郵件。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2023 年 12 月 | [[!DNL Workfront]：套用版面配置範本](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23173.html) | 新文章 | 了解如何透過四種方式套用版面配置範本：[!UICONTROL 使用者輪廓]、[!UICONTROL 工作角色]、[!UICONTROL 主團隊]和[!UICONTROL 主群組]。 |
