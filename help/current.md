...
| 2026 年 1 月 | 由於AEP[[!DNL Databricks] 中的SAS權杖過期，](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-29715)聯結器失敗 | 新文章 | 瞭解基礎架構變更後[!DNL Databricks]聯結器停止運作，或Spark設定中的SAS ([!DNL Shared Access Signature])權杖過期或在AEP中重新整理時，此問題的解決方案。 |
...
| 2026 年 1 月 | 在AEP[中將區段匯出至 [!DNL LiveRamp] 時發生](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-29774)驗證錯誤 | 新文章 | 瞭解從生產沙箱將區段匯出到Adobe Experience Platform中的[!DNL LiveRamp]上線目的地時出現驗證錯誤時問題的解決方案。 |
...
| 2026 年 1 月 | [整合 [!DNL The Trade Desk] 與Adobe Experience Platform並收集 [!DNL The Trade Desk ID]](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-29847) | 新文章 | 瞭解在整合[!DNL The Trade Desk ID]與Adobe Experience Platform時，透過Web SDK收集及對應[!DNL The Trade Desk]存在不確定性時的問題解決方案。 |
...
| 2026 年 1 月 | 由於AEM[中的Java版本不符，](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-28132)TCP定位器無法啟動 | 新文章 | 瞭解當TCP定位器無法啟動時，因為在叢集環境中，SP22 Hotfix之後需要JDK 17或更新版本，問題的解決方案。 |
| 2026 年 1 月 | 在AEM as a Cloud Service或AEM 6.5中使用Dispatcher[的[!UICONTROL 發佈]上，](https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-kcs/kbarticles/ka-28174)ZIP資產傳回404 | 新文章 | 瞭解當上傳至AEM DAM的ZIP檔案在[!UICONTROL 作者]中發佈但於[!UICONTROL 發佈]存取時傳回404錯誤(因為Dispatcher預設會封鎖ZIP要求)問題的解決方案。 |
...
| 發佈日期 | 應用程式 | 名稱 | 類型 | 說明 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2026 年 2 月 | [!DNL Journey Optimizer] | [傳送歷程的直接郵件訊息](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/channels/direct-mail-channel/direct-mail-in-journeys.html?lang=zh-Hant) | 影片 | 探索如何在Adobe Journey Optimizer中善用直接郵件頻道，以自動化並排程歷程中的直接郵件傳遞。 |
| 2026 年 2 月 | [!DNL Journey Optimizer] | [使用AJO Decisioning最佳化推送通知](https://experienceleague.adobe.com/zh-hant/docs/journey-optimizer-learn/tutorials/decision-capabilities/decisioning/decisioning-in-push-notifications) | 影片 | 瞭解如何使用 AJO 決策，將客群的推播通知個人化。根據收件者設定檔建立吸引人的優惠方案以提高銷售量。 |
