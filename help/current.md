...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2026 年 2 月 | [Adobe Analytics上線](https://experienceleague.adobe.com/en/docs/analytics/analyze/admin-overview/onboard) | 影片 | 加入支援Adobe Analytics的主要Adobe平台，協助您和您的組織獲得成功。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2026 年 2 月 | [資料Storytelling：產生投影片簡報](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/curate-and-share/data-storytelling-generate-slides.html) | 影片 | 探索Adobe Customer Journey Analytics中的強大資料Storytelling功能，該功能使用創作AI將您的Analysis Workspace專案轉換為專業的PowerPoint簡報，其中包含精選的視覺效果、關鍵深入分析和引人入勝的敘述。 |
| 2026 年 2 月 | Customer Journey Analytics中的[線條視覺效果](https://experienceleague.adobe.com/en/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/visualizations/line-visualization) | 影片 | 探索折線圖視覺效果如何隨時間強化您對量度的瞭解。 自訂X/Y軸、顯示最小/最大標籤，以及新增趨勢線以透過Customer Journey Analytics改善您的資料深入分析。 |
| 2026 年 2 月 | [為什麼選擇CJA？ CJA與Adobe Analytics的戰略審查](https://experienceleague.adobe.com/en/docs/customer-journey-analytics-learn/tutorials/cja-basics/why-cja-modernize-customer-analytics) | 影片 | 瞭解以Adobe Experience Platform為基礎的Adobe Customer Journey Analytics (CJA)如何克服傳統Adobe Analytics的限制。 |
| 2026 年 2 月 | [自由表格中有多個維度欄](https://experienceleague.adobe.com/en/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/visualizations/multiple-dimension-columns-in-freeform-tables) | 影片 | 使用CJA中的多個Dimension欄功能，讓您的自由表格功能更強大。 |
| 2026 年 2 月 | [在Customer Journey Analytics中新增長條圖視覺效果至Analysis Workspace專案](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/visualizations/add-bar-visualizations.html) | 影片 | 瞭解如何在Customer Journey Analytics的Analysis Workspace專案中新增及設定標準橫條圖和棧疊橫條圖視覺效果。 |
...
| 發佈日期 | 應用程式 | 名稱 | 格式 | 說明 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2026 年 2 月 | [!DNL AEM CS] | [開發代理程式總覽](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/ai-in-aem/agents/development/overview) | 影片 | 瞭解AEM中的開發代理程式如何分析Cloud Manager中的失敗管道和建置記錄檔，以建議程式碼修正並加快偵錯速度。 |
| 2026 年 2 月 | [!DNL AEM Assets] | [Adobe快照](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/dynamic-media-snapshot.html) | 影片 | Adobe Snapshot是視覺化展示工具，旨在說明Dynamic Media在最佳化及動態影像傳送方面的強大功能。 |
| 2026 年 2 月 | [!DNL AEM CS] | 在AEM as a Cloud Service中還原[內容](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/cloud-manager/content-restore) | 影片 | 透過此逐步教學課程，瞭解如何在AEM as a Cloud Service中還原內容。 瞭解何時以及如何有效率地復原先前的內容，確保內容完整性。 |
...
| 2026 年 1 月 | [重新導向屬性未轉出至AEM即時副本](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29707) | 新文章 | 瞭解當Blueprint頁面上設定的重新導向設定在轉出期間未傳播至即時副本，因為預設MSM動作排除重新導向相關屬性時，問題的解決方案。 |
| 2026 年 1 月 | [在AEMaaCS中設定具有正確Adobe存放庫的EDS專案](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28055) | 新文章 | 瞭解在AEMaaCS中設定Edge Delivery Services專案需要使用正確Adobe範本存放庫時，問題的解決方案。 |
...
| 2026 年 1 月 | [[!DNL Site-Wide Analysis Tool] 報告無法開啟，錯誤要求為&#x200B;*400 — 要求標頭或Cookie太大*&#x200B;錯誤](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27906) | 新文章 | 瞭解當[!DNL Site-Wide Analysis Tool]報告無法開啟並顯示&#x200B;*400錯誤請求錯誤*&#x200B;時問題的解決方案，因為請求標頭或Cookie超過Adobe Commerce Cloud中的伺服器設定限制。 |
| 2026 年 1 月 | [Adobe Commerce的進階報告疑難排解員](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29603) | 新文章 | 瞭解如何診斷及解決Adobe Commerce中的進階報告問題。 |
| 2026 年 1 月 | Adobe Commerce中的[[!DNL Cloudflare] 逾時和重新導向問題](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29759) | 新文章 | 瞭解[!DNL Cloudflare]設定在Adobe Commerce環境中造成逾時和重新導向問題時的問題解決方案。 |
| 2026 年 1 月 | [資料庫上載遺失與 [!DNL MySQL]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29843)的連線 | 新文章 | 瞭解當資料庫上載失去與[!DNL MySQL]的連線時，此問題的解決方案。 |
| 2026 年 1 月 | 在Adobe Commerce中啟用影像最佳化時發生[錯誤](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29890) | 新文章 | 瞭解當[!DNL Fastly]影像最佳化([!DNL Fastly] IO)預設為停用，並通知連絡[!DNL Fastly]以啟用影像最佳化時的問題解決方案。 |
| 2026 年 1 月 | [雲端基礎結構上Adobe Commerce中的`var/export`資料夾許可權問題](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29895) | 新文章 | 瞭解解決由於伺服器`var/export/email`資料夾中的檔案許可權問題而無法匯出產品資料時的問題。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
|---------|----|----|-----------|
| 2026 年 1 月 | [修正Adobe Campaign Managed Cloud中膨脹的使用中設定檔計數](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29761) | 新文章 | 瞭解當多個目標對應共用相同記錄結構描述時，會造成Adobe Campaign Managed Cloud中的作用中設定檔計數非預期增加的問題。 |
| 2026 年 1 月 | [Campaign Standard：選取獲勝者時，A/B測試傳送仍擱置中](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29793) | 新文章 | 瞭解當A/B測試在所有變體傳送給收件者之前完成時的問題解決方案。 |
| 2026 年 1 月 | [Campaign Classic：匯出工作流程會導致執行個體當機](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29792) | 新文章 | 瞭解在套件中匯出自訂行銷活動工作流程時當機執行個體時問題的解決方案。 |
...
| 發佈日期 | 應用程式 | 名稱 | 類型 | 說明 |
| ----------| ---------- | ---------- | ---------- |---------- |
| 2026 年 2 月 | [!DNL Journey Optimizer] | [傳送歷程的直接郵件訊息](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/channels/direct-mail-channel/direct-mail-in-journeys.html) | 影片 | 深入探索如何在 Adobe Journey Optimizer 中善用直接郵件頻道，以便進行自動化，同時在歷程中安排直接郵件傳遞。 |
| 2026 年 2 月 | [!DNL Journey Optimizer] | [使用AJO Decisioning最佳化推送通知](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/decision-capabilities/decisioning/decisioning-in-push-notifications) | 影片 | 瞭解如何使用 AJO 決策，將客群的推播通知個人化。 根據收件者的輪廓，建立吸引人的優惠方案，以便推動銷售量。 |
| 2026 年 2 月 | [!DNL Journey Optimizer] | [建立查詢資料集](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/trigger-journey-on-form-submission/lookup-dataset) | 影片 | 建立查詢資料集以用於歷程中。 |
| 2026 年 2 月 | [!DNL Journey Optimizer] | [建立Web推播通知](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/channels/push-channel/create-web-push-notifications.html) | 影片 | 解如何在 Adobe Journey Optimizer 中建立網頁推播通知。 請將您的觸角伸到行動裝置以外，可直接透過網頁瀏覽器吸引使用者。 |
| 2026 年 2 月 | [!DNL Journey Optimizer] | [監視您的自訂動作](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/report-and-monitor/custom-action-monitoring-report) | 影片 | 探索如何有效地監視從您的歷程透過自訂動作對第三方端點發出的HTTP呼叫的運作狀況和效能。 深入瞭解HTTP錯誤、延遲瓶頸，以及可能影響傳送的限制問題。 |
| 2026 年 2 月 | [!DNL Journey Optimizer] | [在SMS訊息中使用決策](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/decision-capabilities/decisioning/use-decisioning-in-an-sms-message) | 影片 | 瞭解如何使用AJO Decisioning來個人化和最佳化簡訊內容。 增強您的SMS訊息，以改善參與度並達成業務目標。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
|---------|----|----|-----------|
| 2026 年 1 月 | [由於事件時間和AJO中的批次擷取，對象資格失敗](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29796) | 新文章 | 瞭解當對象資格因事件超出Adobe Journey Optimizer對象條件中定義的評估期間而失敗時的問題解決方案。 |
...
| 發佈日期 | 名稱 | 類型 | 說明 |
| -----------| ---------- | ---------- | ---------- |
| 2026 年 2 月 | 適用於GenStudio for Performance Marketing的[Photoshop外掛程式](https://experienceleague.adobe.com/en/docs/genstudio-for-performance-marketing/user-guide/integrations/photoshop-plugin) | 影片 | 瞭解如何安裝、設定和使用GenStudio for Performance Marketing的Photoshop外掛程式。 |
